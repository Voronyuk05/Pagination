function t(t,e,n,r){Object.defineProperty(t,e,{get:n,set:r,enumerable:!0,configurable:!0})}var e,n,r,i,o,s,a,u,l,c,p,h,f,d,g,m,v,y,_,S,k,b,P,C,x,L,E,w,A,O,M,N,I,R,B,D,$,j,H,T,U,F,V,G,q,K,W,J,Q,z,Z,X,Y="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},tt={},te={},tn=Y.parcelRequireefa1;null==tn&&((tn=function(t){if(t in tt)return tt[t].exports;if(t in te){var e=te[t];delete te[t];var n={id:t,exports:{}};return tt[t]=n,e.call(n.exports,n,n.exports),n.exports}var r=Error("Cannot find module '"+t+"'");throw r.code="MODULE_NOT_FOUND",r}).register=function(t,e){te[t]=e},Y.parcelRequireefa1=tn),tn.register("9QQ9J",function(e,n){var r,i,o;t(e.exports,"SourceMapGenerator",function(){return r},function(t){return r=t}),t(e.exports,"SourceMapConsumer",function(){return i},function(t){return i=t}),t(e.exports,"SourceNode",function(){return o},function(t){return o=t}),r=tn("ic7WM").SourceMapGenerator,i=tn("lbXUp").SourceMapConsumer,o=tn("Tx9qF").SourceNode}),tn.register("ic7WM",function(e,n){t(e.exports,"SourceMapGenerator",function(){return r},function(t){return r=t});var r,i=tn("duvZU"),o=tn("dQK2c"),s=tn("lSTHk").ArraySet,a=tn("2EyUB").MappingList;/**
...
var i=r.path.lastIndexOf("/");i>=0&&(r.path=r.path.substring(0,i+1))}e=k(_(r),e)}return S(e)}}),tn.register("lSTHk",function(e,n){t(e.exports,"ArraySet",function(){return r},function(t){return r=t});var r,i=tn("dQK2c"),o=Object.prototype.hasOwnProperty,s="undefined"!=typeof Map;/**
 ...
 */a.prototype.toArray=function(){return this._array.slice()},r=a}),tn.register("2EyUB",function(e,n){t(e.exports,"MappingList",function(){return r},function(t){return r=t});var r,i=tn("dQK2c");/**
 ...
 * copy.
 */o.prototype.toArray=function(){return this._sorted||(this._array.sort(i.compareByGeneratedPositionsInflated),this._sorted=!0),this._array},r=o}),tn.register("lbXUp",function(e,n){t(e.exports,"SourceMapConsumer",function(){return r},function(t){return r=t});var r,i=tn("dQK2c"),o=tn("bTtvB"),s=tn("lSTHk").ArraySet,a=tn("duvZU"),u=tn("76ffZ").quickSort;function l(t,e){var n=t;return"string"==typeof t&&(n=i.parseSourceMapInput(t)),null!=n.sections?new h(n,e):new c(n,e)}/**
...
for(;s-1>=0&&0===n(e[s],e[s-1],!0);)--s;return s}}),tn.register("76ffZ",function(e,n){var r;function i(t,e,n){var r=t[e];t[e]=t[n],t[n]=r}t(e.exports,"quickSort",function(){return r},function(t){return r=t}),r=function(t,e){!/**
...
t(e,n,r,c-1),t(e,n,c+1,o)}}(t,e,0,t.length-1)}}),tn.register("Tx9qF",function(e,n){t(e.exports,"SourceNode",function(){return r},function(t){return r=t});var r,i=tn("ic7WM").SourceMapGenerator,o=tn("dQK2c"),s=/(\r?\n)/,a="$$$isSourceNode$$$";/**
 ...
 * map.
 */u.prototype.toStringWithSourceMap=function(t){var e={code:"",line:1,column:0},n=new i(t),r=!1,o=null,s=null,a=null,u=null;return this.walk(function(t,i){e.code+=t,null!==i.source&&null!==i.line&&null!==i.column?((o!==i.source||s!==i.line||a!==i.column||u!==i.name)&&n.addMapping({source:i.source,original:{line:i.line,column:i.column},generated:{line:e.line,column:e.column},name:i.name}),o=i.source,s=i.line,a=i.column,u=i.name,r=!0):r&&(n.addMapping({generated:{line:e.line,column:e.column}}),o=null,r=!1);for(var l=0,c=t.length;l<c;l++)10===t.charCodeAt(l)?(e.line++,e.column=0,l+1===c?(o=null,r=!1):r&&n.addMapping({source:i.source,original:{line:i.line,column:i.column},generated:{line:e.line,column:e.column},name:i.name})):e.column++}),this.walkSourceContents(function(t,e){n.setSourceContent(t,e)}),{code:e.code,map:n}},r=u}),tn.register("5Io6y",function(t,e){});var tr={},ti={};// istanbul ignore next
function to(t){return t&&t.__esModule?t:{default:t}}ti.__esModule=!0;var ts={};// istanbul ignore next
function ta(t){return t&&t.__esModule?t:{default:t}}// istanbul ignore next
function tu(t){if(t&&t.__esModule)return t;var e={};if(null!=t)for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e.default=t,e}ts.__esModule=!0;var tl={};// istanbul ignore next
function tc(t){return t&&t.__esModule?t:{default:t}}t(tl,"__esModule",function(){return h},function(t){return h=t}),t(tl,"HandlebarsEnvironment",function(){return f},function(t){return f=t}),t(tl,"VERSION",function(){return d},function(t){return d=t}),t(tl,"COMPILER_REVISION",function(){return g},function(t){return g=t}),t(tl,"LAST_COMPATIBLE_COMPILER_REVISION",function(){return m},function(t){return m=t}),t(tl,"REVISION_CHANGES",function(){return v},function(t){return v=t}),t(tl,"log",function(){return y},function(t){return y=t}),t(tl,"createFrame",function(){return _},function(t){return _=t}),t(tl,"logger",function(){return S},function(t){return S=t}),h=!0,f=tX;var tp={};t(tp,"__esModule",function(){return k},function(t){return k=t}),t(tp,"extend",function(){return b},function(t){return b=t}),t(tp,"indexOf",function(){return P},function(t){return P=t}),t(tp,"escapeExpression",function(){return C},function(t){return C=t}),t(tp,"isEmpty",function(){return x},function(t){return x=t}),t(tp,"createFrame",function(){return L},function(t){return L=t}),t(tp,"blockParams",function(){return E},function(t){return E=t}),t(tp,"appendContextPath",function(){return w},function(t){return w=t}),t(tp,"toString",function(){return A},function(t){return A=t}),t(tp,"isFunction",function(){return O},function(t){return O=t}),t(tp,"isArray",function(){return M},function(t){return M=t}),k=!0,b=tm,P=// Older IE versions do not directly support indexOf so we must implement our own, sadly.
...
t=""+t}return td.test(t)?t.replace(tf,tg):t},x=function(t){return!t&&0!==t||!!t_(t)&&0===t.length},L=function(t){var e=tm({},t);return e._parent=t,e},E=function(t,e){return t.path=e,t},w=function(t,e){return(t?t+".":"")+e};var th={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","`":"&#x60;","=":"&#x3D;"},tf=/[&<>"'`=]/g,td=/[&<>"'`=]/;function tg(t){return th[t]}function tm(t/* , ...source */){for(var e=1;e<arguments.length;e++)for(var n in arguments[e])Object.prototype.hasOwnProperty.call(arguments[e],n)&&(t[n]=arguments[e][n]);return t}var tv=Object.prototype.toString;A=tv;// Sourced from lodash
// https://github.com/bestiejs/lodash/blob/master/LICENSE.txt
/* eslint-disable func-style */var ty=function(t){return"function"==typeof t};ty(/x/)&&(O=ty=function(t){return"function"==typeof t&&"[object Function]"===tv.call(t)}),O=ty;/* eslint-enable func-style *//* istanbul ignore next */var t_=Array.isArray||function(t){return!!t&&"object"==typeof t&&"[object Array]"===tv.call(t)};M=t_;var tS={};tS.__esModule=!0;var tk=["description","fileName","lineNumber","endLineNumber","message","name","number","stack"];function tb(t,e){var n=e&&e.loc,r=void 0,i=void 0,o=void 0,s=void 0;n&&(r=n.start.line,i=n.end.line,o=n.start.column,s=n.end.column,t+=" - "+r+":"+o);// Unfortunately errors are not enumerable in Chrome (at least), so `for prop in tmp` doesn't work.
for(var a=Error.prototype.constructor.call(this,t),u=0;u<tk.length;u++)this[tk[u]]=a[tk[u]];/* istanbul ignore else */Error.captureStackTrace&&Error.captureStackTrace(this,tb);try{n&&(this.lineNumber=r,this.endLineNumber=i,Object.defineProperty?(Object.defineProperty(this,"column",{value:o,enumerable:!0}),Object.defineProperty(this,"endColumn",{value:s,enumerable:!0})):(this.column=o,this.endColumn=s))}catch(t){/* Ignore if the browser is very particular */}}tb.prototype=Error(),tS.default=tb;var tP=tc(tS=tS.default);// istanbul ignore next
function tC(t){return t&&t.__esModule?t:{default:t}}N=function(t,e,n){t.helpers[e]&&(t.hooks[e]=t.helpers[e],n||delete t.helpers[e])};var tx={};tx.__esModule=!0,tx.default=function(t){t.registerHelper("blockHelperMissing",function(e,n){var r=n.inverse,i=n.fn;if(!0===e)return i(this);if(!1===e||null==e)return r(this);if(M(e))return e.length>0?(n.ids&&(n.ids=[n.name]),t.helpers.each(e,n)):r(this);if(n.data&&n.ids){var o=L(n.data);o.contextPath=w(n.data.contextPath,n.name),n={data:o}}return i(e,n)})};var tL=tC(tx=tx.default),tE={};tE.__esModule=!0;var tw=(e=tS)&&e.__esModule?e:{default:e};tE.default=function(t){t.registerHelper("each",function(t,e){if(!e)throw new tw.default("Must pass iterator to #each");var n=e.fn,r=e.inverse,i=0,o="",s=void 0,a=void 0;function u(e,r,i){s&&(s.key=e,s.index=r,s.first=0===r,s.last=!!i,a&&(s.contextPath=a+e)),o+=n(t[e],{data:s,blockParams:E([t[e],e],[a+e,null])})}if(e.data&&e.ids&&(a=w(e.data.contextPath,e.ids[0])+"."),O(t)&&(t=t.call(this)),e.data&&(s=L(e.data)),t&&"object"==typeof t){if(M(t))for(var l,c=t.length;i<c;i++)i in t&&u(i,i,i===t.length-1);else if(Y.Symbol&&t[Y.Symbol.iterator]){for(var p=[],h=t[Y.Symbol.iterator](),f=h.next();!f.done;f=h.next())p.push(f.value);t=p;for(var c=t.length;i<c;i++)u(i,i,i===t.length-1)}else l=void 0,Object.keys(t).forEach(function(t){void 0!==l&&u(l,i-1),l=t,i++}),void 0!==l&&u(l,i-1,!0)}return 0===i&&(o=r(this)),o})};var tA=tC(tE=tE.default),tO={};tO.__esModule=!0;var tM=(n=tS)&&n.__esModule?n:{default:n};tO.default=function(t){t.registerHelper("helperMissing",function()/* [args, ]options */{if(1!=arguments.length)throw new tM.default('Missing helper: "'+arguments[arguments.length-1].name+'"')})};var tN=tC(tO=tO.default),tI={};tI.__esModule=!0;var tR=(r=tS)&&r.__esModule?r:{default:r};tI.default=function(t){t.registerHelper("if",function(t,e){if(2!=arguments.length)throw new tR.default("#if requires exactly one argument");return(// Default behavior is to render the positive path if the value is truthy and not empty.
// The `includeZero` option may be set to treat the condtional as purely not empty based on the
// behavior of isEmpty. Effectively this determines if 0 is handled by the positive path or negative.
(O(t)&&(t=t.call(this)),!e.hash.includeZero&&!t||x(t))?e.inverse(this):e.fn(this))}),t.registerHelper("unless",function(e,n){if(2!=arguments.length)throw new tR.default("#unless requires exactly one argument");return t.helpers.if.call(this,e,{fn:n.inverse,inverse:n.fn,hash:n.hash})})};var tB=tC(tI=tI.default),tD={};tD.__esModule=!0,tD.default=function(t){t.registerHelper("log",function()/* message, options */{for(var e=[void 0],n=arguments[arguments.length-1],r=0;r<arguments.length-1;r++)e.push(arguments[r]);var i=1;null!=n.hash.level?i=n.hash.level:n.data&&null!=n.data.level&&(i=n.data.level),e[0]=i,t.log.apply(t,e)})};var t$=tC(tD=tD.default),tj={};tj.__esModule=!0,tj.default=function(t){t.registerHelper("lookup",function(t,e,n){return t?n.lookupProperty(t,e):t})};var tH=tC(tj=tj.default),tT={};tT.__esModule=!0;var tU=(i=tS)&&i.__esModule?i:{default:i};tT.default=function(t){t.registerHelper("with",function(t,e){if(2!=arguments.length)throw new tU.default("#with requires exactly one argument");O(t)&&(t=t.call(this));var n=e.fn;if(x(t))return e.inverse(this);var r=e.data;return e.data&&e.ids&&((r=L(e.data)).contextPath=w(e.data.contextPath,e.ids[0])),n(t,{data:r,blockParams:E([t],[r&&r.contextPath])})})};var tF=tC(tT=tT.default),tV={};tV.__esModule=!0,tV.default=function(t){t.registerDecorator("inline",function(t,e,n,r){var i=t;return e.partials||(e.partials={},i=function(r,i){// Create a new partials stack frame prior to exec.
var o=n.partials;n.partials=b({},o,e.partials);var s=t(r,i);return n.partials=o,s}),e.partials[r.args[0]]=r.fn,i})};var tG=(o=tV=tV.default)&&o.__esModule?o:{default:o},tq={};tq.__esModule=!0;var tK={methodMap:["debug","info","warn","error"],level:"info",// Maps a given level value to the `methodMap` indexes above.
lookupLevel:function(t){if("string"==typeof t){var e=P(tK.methodMap,t.toLowerCase());t=e>=0?e:parseInt(t,10)}return t},// Can be overridden in the host environment
log:function(t){if(t=tK.lookupLevel(t),"undefined"!=typeof console&&tK.lookupLevel(tK.level)<=t){var e=tK.methodMap[t];// eslint-disable-next-line no-console
...
}}};tq.default=tK;var tW=tc(tq=tq.default);I=/**
 * Create a new object with "null"-prototype to avoid truthy results on prototype properties.
 * The resulting object can be used with "object[property]" to check if a property exists
 * @param {...object} sources a varargs parameter of source objects that will be merged
 * @returns {object}
 */function(){for(var t=arguments.length,e=Array(t),n=0;n<t;n++)e[n]=arguments[n];return b.apply(void 0,[Object.create(null)].concat(e))};var tJ=// istanbul ignore next
function(t){if(t&&t.__esModule)return t;var e={};if(null!=t)for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e.default=t,e}(tq),tQ=Object.create(null);function tz(t,e){return void 0!==t.whitelist[e]?!0===t.whitelist[e]:void 0!==t.defaultValue?t.defaultValue:(!0!==tQ[e]&&(tQ[e]=!0,tJ.log("error",'Handlebars: Access has been denied to resolve the property "'+e+'" because it is not an "own property" of its parent.\nYou can add a runtime option to disable the check or this warning:\nSee https://handlebarsjs.com/api-reference/runtime-options.html#options-to-control-prototype-access for details')),!1)}d="4.7.7",g=8,m=7,v={1:"<= 1.0.rc.2",2:"== 1.0.0-rc.3",3:"== 1.0.0-rc.4",4:"== 1.x.x",5:"== 2.0.0-alpha.x",6:">= 2.0.0-beta.1",7:">= 4.0.0 <4.3.0",8:">= 4.3.0"};var tZ="[object Object]";function tX(t,e,n){this.helpers=t||{},this.partials=e||{},this.decorators=n||{},tL.default(this),tA.default(this),tN.default(this),tB.default(this),t$.default(this),tH.default(this),tF.default(this),tG.default(this)}tX.prototype={constructor:tX,logger:tW.default,log:tW.default.log,registerHelper:function(t,e){if(A.call(t)===tZ){if(e)throw new tP.default("Arg not supported with multiple helpers");b(this.helpers,t)}else this.helpers[t]=e},unregisterHelper:function(t){delete this.helpers[t]},registerPartial:function(t,e){if(A.call(t)===tZ)b(this.partials,t);else{if(void 0===e)throw new tP.default('Attempting to register a partial called "'+t+'" as undefined');this.partials[t]=e}},unregisterPartial:function(t){delete this.partials[t]},registerDecorator:function(t,e){if(A.call(t)===tZ){if(e)throw new tP.default("Arg not supported with multiple decorators");b(this.decorators,t)}else this.decorators[t]=e},unregisterDecorator:function(t){delete this.decorators[t]},/**
   * Reset the memory of illegal property accesses that have already been logged.
   * @deprecated should only be used in handlebars test-cases
   */resetLoggedPropertyAccesses:function(){Object.keys(tQ).forEach(function(t){delete tQ[t]})}},y=tW.default.log,_=L,S=tW.default;var tY=tu(tl),t2={};function t1(t){this.string=t}t2.__esModule=!0,t1.prototype.toString=t1.prototype.toHTML=function(){return""+this.string},t2.default=t1;var t0=ta(t2=t2.default),t3=ta(tS),t4=tu(tp),t8={};t(t8,"__esModule",function(){return R},function(t){return R=t}),t(t8,"checkRevision",function(){return B},function(t){return B=t}),t(t8,"template",function(){return D},function(t){return D=t}),t(t8,"wrapProgram",function(){return $},function(t){return $=t}),t(t8,"resolvePartial",function(){return j},function(t){return j=t}),t(t8,"invokePartial",function(){return H},function(t){return H=t}),t(t8,"noop",function(){return T},function(t){return T=t}),R=!0,B=function(t){var e=t&&t[0]||1,n=g;if(!(e>=m)||!(e<=g)){if(e<m){var r=v[n],i=v[e];throw new t7.default("Template was precompiled with an older version of Handlebars than the current runtime. Please update your precompiler to a newer version ("+r+") or downgrade your runtime to an older version ("+i+").")}throw new t7.default("Template was precompiled with a newer version of Handlebars than the current runtime. Please update your runtime to a newer version ("+t[1]+").")}},D=function(t,e){/* istanbul ignore next */if(!e)throw new t7.default("No environment passed to template");if(!t||!t.main)throw new t7.default("Unknown template object: "+typeof t);t.main.decorator=t.main_d,// Note: Using env.VM references rather than local var references throughout this section to allow
...
var n=t.compiler&&7===t.compiler[0],r={strict:function(t,e,n){if(!t||!(e in t))throw new t7.default('"'+e+'" not defined in '+t,{loc:n});return r.lookupProperty(t,e)},lookupProperty:function(t,e){var n,i=t[e];if(null==i||Object.prototype.hasOwnProperty.call(t,e)||(n=r.protoAccessControl,"function"==typeof i?tz(n.methods,e):tz(n.properties,e)))return i},lookup:function(t,e){for(var n=t.length,i=0;i<n;i++)if(null!=(t[i]&&r.lookupProperty(t[i],e)))return t[i][e]},lambda:function(t,e){return"function"==typeof t?t.call(e):t},escapeExpression:t5.escapeExpression,invokePartial:function(n,r,i){i.hash&&(r=t5.extend({},r,i.hash),i.ids&&(i.ids[0]=!0)),n=e.VM.resolvePartial.call(this,n,r,i);var o=t5.extend({},i,{hooks:this.hooks,protoAccessControl:this.protoAccessControl}),s=e.VM.invokePartial.call(this,n,r,o);if(null==s&&e.compile&&(i.partials[i.name]=e.compile(n,t.compilerOptions,e),s=i.partials[i.name](r,o)),null!=s){if(i.indent){for(var a=s.split("\n"),u=0,l=a.length;u<l&&(a[u]||u+1!==l);u++)a[u]=i.indent+a[u];s=a.join("\n")}return s}throw new t7.default("The partial "+i.name+" could not be compiled when running in runtime-only mode")},fn:function(e){var n=t[e];return n.decorator=t[e+"_d"],n},programs:[],program:function(t,e,n,r,i){var o=this.programs[t],s=this.fn(t);return e||i||r||n?o=t6(this,t,s,e,n,r,i):o||(o=this.programs[t]=t6(this,t,s)),o},data:function(t,e){for(;t&&e--;)t=t._parent;return t},mergeIfNeeded:function(t,e){var n=t||e;return t&&e&&t!==e&&(n=t5.extend({},e,t)),n},// An empty object to use as replacement for null-contexts
nullContext:Object.seal({}),noop:e.VM.noop,compilerInfo:t.compiler};function i(e){var n,o=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],s=o.data;i._setup(o),!o.partial&&t.useData&&((n=s)&&"root"in n||((n=n?_(n):{}).root=e),s=n);var a=void 0,u=t.useBlockParams?[]:void 0;function l(e/*, options*/){return""+t.main(r,e,r.helpers,r.partials,s,u,a)}return t.useDepths&&(a=o.depths?e!=o.depths[0]?[e].concat(o.depths):o.depths:[e]),(l=et(t.main,l,r,o.depths||[],s,u))(e,o)}return i.isTop=!0,i._setup=function(i){if(i.partial)r.protoAccessControl=i.protoAccessControl,r.helpers=i.helpers,r.partials=i.partials,r.decorators=i.decorators,r.hooks=i.hooks;else{var o,s,a=t5.extend({},e.helpers,i.helpers);(function(t,e){Object.keys(t).forEach(function(n){var r,i=t[n];t[n]=(r=e.lookupProperty,"function"!=typeof i?i:function()/* dynamic arguments */{var t,e=arguments[arguments.length-1];return arguments[arguments.length-1]=(t=e,t5.extend({lookupProperty:r},t)),i.apply(this,arguments)})})})(a,r),r.helpers=a,t.usePartial&&(r.partials=r.mergeIfNeeded(i.partials,e.partials)),(t.usePartial||t.useDecorators)&&(r.decorators=t5.extend({},e.decorators,i.decorators)),r.hooks={},r.protoAccessControl=((o=Object.create(null)).constructor=!1,o.__defineGetter__=!1,o.__defineSetter__=!1,o.__lookupGetter__=!1,// eslint-disable-next-line no-proto
(s=Object.create(null)).__proto__=!1,{properties:{whitelist:I(s,i.allowedProtoProperties),defaultValue:i.allowProtoPropertiesByDefault},methods:{whitelist:I(o,i.allowedProtoMethods),defaultValue:i.allowProtoMethodsByDefault}});var u=i.allowCallsToHelperMissing||n;N(r,"helperMissing",u),N(r,"blockHelperMissing",u)}},i._child=function(e,n,i,o){if(t.useBlockParams&&!i)throw new t7.default("must pass block params");if(t.useDepths&&!o)throw new t7.default("must pass parent depths");return t6(r,e,t[e],n,0,i,o)},i},$=t6,j=/**
...
var r,i=n.data&&n.data["partial-block"];n.partial=!0,n.ids&&(n.data.contextPath=n.ids[0]||n.data.contextPath);var o=void 0;if(n.fn&&n.fn!==t9&&(n.data=_(n.data),r=n.fn,o=n.data["partial-block"]=function(t){var e=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];return(// Restore the partial-block from the closure for the execution of the block
// i.e. the part inside the block of the partial call.
e.data=_(e.data),e.data["partial-block"]=i,r(t,e))},r.partials&&(n.partials=t5.extend({},n.partials,r.partials))),void 0===t&&o&&(t=o),void 0===t)throw new t7.default("The partial "+n.name+" could not be found");if(t instanceof Function)return t(e,n)},T=t9;var t5=// istanbul ignore next
function(t){if(t&&t.__esModule)return t;var e={};if(null!=t)for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e.default=t,e}(tp),t7=(s=tS)&&s.__esModule?s:{default:s};function t6(t,e,n,r,i,o,s){function a(e){var i=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],a=s;return s&&e!=s[0]&&!(e===t.nullContext&&null===s[0])&&(a=[e].concat(s)),n(t,e,t.helpers,t.partials,i.data||r,o&&[i.blockParams].concat(o),a)}return(a=et(n,a,t,s,r,o)).program=e,a.depth=s?s.length:0,a.blockParams=i||0,a}function t9(){return""}function et(t,e,n,r,i,o){if(t.decorator){var s={};e=t.decorator(e,s,n,r&&r[0],i,o,r),t5.extend(e,s)}return e}var ee=tu(t8),en={};en.__esModule=!0,en.default=function(t){/* istanbul ignore next */var e=void 0!==Y?Y:window,n=e.Handlebars;/* istanbul ignore next */t.noConflict=function(){return e.Handlebars===t&&(e.Handlebars=n),t}};var er=ta(en=en.default);// For compatibility and usage outside of module systems, make the Handlebars object a namespace
function ei(){var t=new tY.HandlebarsEnvironment;return t4.extend(t,tY),t.SafeString=t0.default,t.Exception=t3.default,t.Utils=t4,t.escapeExpression=t4.escapeExpression,t.VM=ee,t.template=function(e){return ee.template(e,t)},t}var eo=ei();eo.create=ei,er.default(eo),eo.default=eo,ts.default=eo;var es=to(ts=ts.default),ea={};ea.__esModule=!0;var eu={// Public API used to evaluate derived attributes regarding AST nodes
...
if(n&&!ev.prototype[n.type])throw new em.default('Unexpected node type "'+n.type+'" found when accepting '+e+" on "+t.type);t[e]=n}},// Performs an accept operation with added sanity check to ensure
...
// content is met.
function ex(t,e,n){var r=t[null==e?0:e+1];if(r&&"ContentStatement"===r.type&&(n||!r.rightStripped)){var i=r.value;r.value=r.value.replace(n?/^\s+/:/^[ \t]*\r?\n?/,""),r.rightStripped=r.value!==i}}// Marks the node to the left of the position as omitted.
// I.e. ' '{{foo}} will mark the ' ' node as omitted.
//
...
// If mulitple is truthy then all whitespace will be stripped out until non-whitespace
// content is met.
function eL(t,e,n){var r=t[null==e?t.length-1:e-1];if(r&&"ContentStatement"===r.type&&(n||!r.leftStripped)){// We omit the last node if it's whitespace only and not preceded by a non-content node.
var i=r.value;return r.value=r.value.replace(n?/\s+$/:/[ \t]+$/,""),r.leftStripped=r.value!==i,r.leftStripped}}eb.prototype=new ek.default,eb.prototype.Program=function(t){var e=!this.options.ignoreStandalone,n=!this.isRootSeen;this.isRootSeen=!0;for(var r=t.body,i=0,o=r.length;i<o;i++){var s=r[i],a=this.accept(s);if(a){var u=eP(r,i,n),l=eC(r,i,n),c=a.openStandalone&&u,p=a.closeStandalone&&l,h=a.inlineStandalone&&u&&l;a.close&&ex(r,i,!0),a.open&&eL(r,i,!0),e&&h&&(ex(r,i),eL(r,i)&&"PartialStatement"===s.type&&(s.indent=/([ \t]+$)/.exec(r[i-1].original)[1])),e&&c&&(ex((s.program||s.inverse).body),// Strip out the previous content node if it's whitespace only
eL(r,i)),e&&p&&(// Always strip the next node
ex(r,i),eL((s.inverse||s.program).body))}}return t},eb.prototype.BlockStatement=eb.prototype.DecoratorBlock=eb.prototype.PartialBlockStatement=function(t){this.accept(t.program),this.accept(t.inverse);// Find the inverse program that is involed with whitespace stripping.
...
openStandalone:eC(e.body),closeStandalone:eP((r||e).body)};if(t.openStrip.close&&ex(e.body,null,!0),n){var s=t.inverseStrip;s.open&&eL(e.body,null,!0),s.close&&ex(r.body,null,!0),t.closeStrip.open&&eL(i.body,null,!0),!this.options.ignoreStandalone&&eP(e.body)&&eC(r.body)&&(eL(e.body),ex(r.body))}else t.closeStrip.open&&eL(e.body,null,!0);return o},eb.prototype.Decorator=eb.prototype.MustacheStatement=function(t){return t.strip},eb.prototype.PartialStatement=eb.prototype.CommentStatement=function(t){/* istanbul ignore next */var e=t.strip||{};return{inlineStandalone:!0,open:e.open,close:e.close}},ed.default=eb;var eE=ec(ed=ed.default),ew={};t(ew,"__esModule",function(){return F},function(t){return F=t}),t(ew,"SourceLocation",function(){return V},function(t){return V=t}),t(ew,"id",function(){return G},function(t){return G=t}),t(ew,"stripFlags",function(){return q},function(t){return q=t}),t(ew,"stripComment",function(){return K},function(t){return K=t}),t(ew,"preparePath",function(){return W},function(t){return W=t}),t(ew,"prepareMustache",function(){return J},function(t){return J=t}),t(ew,"prepareRawBlock",function(){return Q},function(t){return Q=t}),t(ew,"prepareBlock",function(){return z},function(t){return z=t}),t(ew,"prepareProgram",function(){return Z},function(t){return Z=t}),t(ew,"preparePartialBlock",function(){return X},function(t){return X=t}),F=!0,V=function(t,e){this.source=t,this.start={line:e.first_line,column:e.first_column},this.end={line:e.last_line,column:e.last_column}},G=function(t){return/^\[.*\]$/.test(t)?t.substring(1,t.length-1):t},q=function(t,e){return{open:"~"===t.charAt(2),close:"~"===e.charAt(e.length-3)}},K=function(t){return t.replace(/^\{\{~?!-?-?/,"").replace(/-?-?~?\}\}$/,"")},W=function(t,e,n){n=this.locInfo(n);for(var r=t?"@":"",i=[],o=0,s=0,a=e.length;s<a;s++){var u=e[s].part,// i.e. foo.[this] resolves to approximately context.foo['this']
l=e[s].original!==u;if(r+=(e[s].separator||"")+u,l||".."!==u&&"."!==u&&"this"!==u)i.push(u);else{if(i.length>0)throw new eA.default("Invalid path: "+r,{loc:n});".."===u&&o++}}return{type:"PathExpression",data:t,depth:o,parts:i,original:r,loc:n}},J=function(t,e,n,r,i,o){// Must use charAt to support IE pre-10
var s=r.charAt(3)||r.charAt(2);return{type:/\*/.test(r)?"Decorator":"MustacheStatement",path:t,params:e,hash:n,escaped:"{"!==s&&"&"!==s,strip:i,loc:this.locInfo(o)}},Q=function(t,e,n,r){eO(t,n);var i={type:"Program",body:e,strip:{},loc:r=this.locInfo(r)};return{type:"BlockStatement",path:t.path,params:t.params,hash:t.hash,program:i,openStrip:{},inverseStrip:{},closeStrip:{},loc:r}},z=function(t,e,n,r,i,o){r&&r.path&&eO(t,r);var s=/\*/.test(t.open);e.blockParams=t.blockParams;var a=void 0,u=void 0;if(n){if(s)throw new eA.default("Unexpected inverse block on decorator",n);n.chain&&(n.program.body[0].closeStrip=r.strip),u=n.strip,a=n.program}return i&&(i=a,a=e,e=i),{type:s?"DecoratorBlock":"BlockStatement",path:t.path,params:t.params,hash:t.hash,program:e,inverse:a,openStrip:t.strip,inverseStrip:u,closeStrip:r&&r.strip,loc:this.locInfo(o)}},Z=function(t,e){if(!e&&t.length){var n=t[0].loc,r=t[t.length-1].loc;/* istanbul ignore else */n&&r&&(e={source:n.source,start:{line:n.start.line,column:n.start.column},end:{line:r.end.line,column:r.end.column}})}return{type:"Program",body:t,strip:{},loc:e}},X=function(t,e,n,r){return eO(t,n),{type:"PartialBlockStatement",name:t.path,params:t.params,hash:t.hash,program:e,openStrip:t.strip,closeStrip:n&&n.strip,loc:this.locInfo(r)}};var eA=(l=tS)&&l.__esModule?l:{default:l};function eO(t,e){if(e=e.path?e.path.original:e,t.path.original!==e){var n={loc:t.path.loc};throw new eA.default(t.path.original+" doesn't match "+e,n)}}var eM=// istanbul ignore next
function(t){if(t&&t.__esModule)return t;var e={};if(null!=t)for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e.default=t,e}(ew);U=ef.default;var eN={};function eI(t,e){return(// Just return if an already-compiled AST was passed in.
"Program"===t.type?t:(ef.default.yy=eN,// Altering the shared object here, but this is ok as parser is a sync operation
eN.locInfo=function(t){return new eN.SourceLocation(e&&e.srcName,t)},ef.default.parse(t)))}function eR(t,e){var n=eI(t,e);return new eE.default(e).accept(n)}// istanbul ignore next
function eB(t){return t&&t.__esModule?t:{default:t}}b(eN,eM);var eD=eB(tS),e$=eB(ea),ej=[].slice;function eH(){}function eT(t){if(!t.path.parts){var e=t.path;// Casting to string here to make false and 0 literal values play nicely with the rest
// of the system.
...
eH.prototype={compiler:eH,equals:function(t){var e=this.opcodes.length;if(t.opcodes.length!==e)return!1;for(var n=0;n<e;n++){var r=this.opcodes[n],i=t.opcodes[n];if(r.opcode!==i.opcode||!function t(e,n){if(e===n)return!0;if(M(e)&&M(n)&&e.length===n.length){for(var r=0;r<e.length;r++)if(!t(e[r],n[r]))return!1;return!0}}(r.args,i.args))return!1}// We know that length is the same between the two arrays because they are directly tied
// to the opcode behavior above.
e=this.children.length;for(var n=0;n<e;n++)if(!this.children[n].equals(t.children[n]))return!1;return!0},guid:0,compile:function(t,e){return this.sourceNode=[],this.opcodes=[],this.children=[],this.options=e,this.stringParams=e.stringParams,this.trackIds=e.trackIds,e.blockParams=e.blockParams||[],e.knownHelpers=b(Object.create(null),{helperMissing:!0,blockHelperMissing:!0,each:!0,if:!0,unless:!0,with:!0,log:!0,lookup:!0},e.knownHelpers),this.accept(t)},compileProgram:function(t){var e=new this.compiler().compile(t,this.options),n=this.guid++;return this.usePartial=this.usePartial||e.usePartial,this.children[n]=e,this.useDepths=this.useDepths||e.useDepths,n},accept:function(t){/* istanbul ignore next: Sanity code */if(!this[t.type])throw new eD.default("Unknown type: "+t.type,t);this.sourceNode.unshift(t);var e=this[t.type](t);return this.sourceNode.shift(),e},Program:function(t){this.options.blockParams.unshift(t.blockParams);for(var e=t.body,n=e.length,r=0;r<n;r++)this.accept(e[r]);return this.options.blockParams.shift(),this.isSimple=1===n,this.blockParams=t.blockParams?t.blockParams.length:0,this},BlockStatement:function(t){eT(t);var e=t.program,n=t.inverse;e=e&&this.compileProgram(e),n=n&&this.compileProgram(n);var r=this.classifySexpr(t);"helper"===r?this.helperSexpr(t,e,n):"simple"===r?(this.simpleSexpr(t),// now that the simple mustache is resolved, we need to
...
this.accept(t);else{if(this.trackIds){var n=void 0;if(!t.parts||e$.default.helpers.scopedId(t)||t.depth||(n=this.blockParamIndex(t.parts[0])),n){var r=t.parts.slice(1).join(".");this.opcode("pushId","BlockParam",n,r)}else(e=t.original||e).replace&&(e=e.replace(/^this(?:\.|$)/,"").replace(/^\.\//,"").replace(/^\.$/,"")),this.opcode("pushId",t.type,e)}this.accept(t)}},setupFullMustacheParams:function(t,e,n,r){var i=t.params;return this.pushParams(i),this.opcode("pushProgram",e),this.opcode("pushProgram",n),t.hash?this.accept(t.hash):this.opcode("emptyHash",r),i},blockParamIndex:function(t){for(var e=0,n=this.options.blockParams.length;e<n;e++){var r=this.options.blockParams[e],i=r&&P(r,t);if(r&&i>=0)return[e,i]}}};var eU={};// istanbul ignore next
function eF(t){return t&&t.__esModule?t:{default:t}}eU.__esModule=!0;var eV=eF(tS),eG={};eG.__esModule=!0;var eq=void 0;try{/* istanbul ignore next */"function"==typeof define&&define.amd||(eq=tn("9QQ9J").SourceNode)}catch(t){}function eK(t,e,n){if(M(t)){for(var r=[],i=0,o=t.length;i<o;i++)r.push(e.wrap(t[i],n));return r}return"boolean"==typeof t||"number"==typeof t?t+"":t}function eW(t){this.srcFile=t,this.source=[]}eq||/* istanbul ignore next */((eq=function(t,e,n,r){this.src="",r&&this.add(r)}).prototype={add:function(t){M(t)&&(t=t.join("")),this.src+=t},prepend:function(t){M(t)&&(t=t.join("")),this.src=t+this.src},toStringWithSourceMap:function(){return{code:this.toString()}},toString:function(){return this.src}}),eW.prototype={isEmpty:function(){return!this.source.length},prepend:function(t,e){this.source.unshift(this.wrap(t,e))},push:function(t,e){this.source.push(this.wrap(t,e))},merge:function(){var t=this.empty();return this.each(function(e){t.add(["  ",e,"\n"])}),t},each:function(t){for(var e=0,n=this.source.length;e<n;e++)t(this.source[e])},empty:function(){var t=this.currentLocation||{start:{}};return new eq(t.start.line,t.start.column,this.srcFile)},wrap:function(t){var e=arguments.length<=1||void 0===arguments[1]?this.currentLocation||{start:{}}:arguments[1];return t instanceof eq?t:(t=eK(t,this,e),new eq(e.start.line,e.start.column,this.srcFile,t))},functionCall:function(t,e,n){return n=this.generateList(n),this.wrap([t,e?"."+e+"(":"(",n,")"])},quotedString:function(t){return'"'+(t+"").replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\n/g,"\\n").replace(/\r/g,"\\r").replace(/\u2028/g,"\\u2028")// Per Ecma-262 7.3 + 7.8.4
.replace(/\u2029/g,"\\u2029")+'"'},objectLiteral:function(t){// istanbul ignore next
var e=this,n=[];Object.keys(t).forEach(function(r){var i=eK(t[r],e);"undefined"!==i&&n.push([e.quotedString(r),":",i])});var r=this.generateList(n);return r.prepend("{"),r.add("}"),r},generateList:function(t){for(var e=this.empty(),n=0,r=t.length;n<r;n++)n&&e.add(","),e.add(eK(t[n],this));return e},generateArray:function(t){var e=this.generateList(t);return e.prepend("["),e.add("]"),e}},eG.default=eW;var eJ=eF(eG=eG.default);function eQ(t){this.value=t}function ez(){}ez.prototype={// PUBLIC API: You can override these methods in a subclass to provide
...
r=!0;var s=this.incrStack();e=["((",this.push(s)," = ",o,")"],n=this.topStack()}var a=t.call(this,n);i||this.popStack(),r&&this.stackSlot--,this.push(e.concat(a,")"))},incrStack:function(){return this.stackSlot++,this.stackSlot>this.stackVars.length&&this.stackVars.push("stack"+this.stackSlot),this.topStackName()},topStackName:function(){return"stack"+this.stackSlot},flushInline:function(){var t=this.inlineStack;this.inlineStack=[];for(var e=0,n=t.length;e<n;e++){var r=t[e];/* istanbul ignore if */if(r instanceof eQ)this.compileStack.push(r);else{var i=this.incrStack();this.pushSource([i," = ",r,";"]),this.compileStack.push(i)}}},isInline:function(){return this.inlineStack.length},popStack:function(t){var e=this.isInline(),n=(e?this.inlineStack:this.compileStack).pop();if(!t&&n instanceof eQ)return n.value;if(!e){/* istanbul ignore next */if(!this.stackSlot)throw new eV.default("Invalid stack pop");this.stackSlot--}return n},topStack:function(){var t=this.isInline()?this.inlineStack:this.compileStack,e=t[t.length-1];return /* istanbul ignore if */e instanceof eQ?e.value:e},contextName:function(t){return this.useDepths&&t?"depths["+t+"]":"depth"+t},quotedString:function(t){return this.source.quotedString(t)},objectLiteral:function(t){return this.source.objectLiteral(t)},aliasable:function(t){var e=this.aliases[t];return e?e.referenceCount++:((e=this.aliases[t]=this.source.wrap(t)).aliasable=!0,e.referenceCount=1),e},setupHelper:function(t,e,n){var r=[],i=this.setupHelperArgs(e,t,r,n);return{params:r,paramsInit:i,name:this.nameLookup("helpers",e,"helper"),callParams:[this.aliasable(this.contextName(0)+" != null ? "+this.contextName(0)+" : (container.nullContext || {})")].concat(r)}},setupParams:function(t,e,n){var r={},i=[],o=[],s=[],a=!n,u=void 0;a&&(n=[]),r.name=this.quotedString(t),r.hash=this.popStack(),this.trackIds&&(r.hashIds=this.popStack()),this.stringParams&&(r.hashTypes=this.popStack(),r.hashContexts=this.popStack());var l=this.popStack(),c=this.popStack();(c||l)&&(r.fn=c||"container.noop",r.inverse=l||"container.noop");for(// The parameters go on to the stack in order (making sure that they are evaluated in order)
// so we need to pop them off the stack in reverse order
var p=e;p--;)u=this.popStack(),n[p]=u,this.trackIds&&(s[p]=this.popStack()),this.stringParams&&(o[p]=this.popStack(),i[p]=this.popStack());return a&&(r.args=this.source.generateArray(n)),this.trackIds&&(r.ids=this.source.generateArray(s)),this.stringParams&&(r.types=this.source.generateArray(o),r.contexts=this.source.generateArray(i)),this.options.data&&(r.data="data"),this.useBlockParams&&(r.blockParams="blockParams"),r},setupHelperArgs:function(t,e,n,r){var i=this.setupParams(t,e,n);return(i.loc=JSON.stringify(this.source.currentLocation),i=this.objectLiteral(i),r)?(this.useRegister("options"),n.push("options"),["options=",i]):n?(n.push(i),""):i}},function(){for(var t="break else new var case finally return void catch for switch while continue function this with default if throw delete in try do instanceof typeof abstract enum int short boolean export interface static byte extends long super char final native synchronized class float package throws const goto private transient debugger implements protected volatile double import public let yield await null true false".split(" "),e=ez.RESERVED_WORDS={},n=0,r=t.length;n<r;n++)e[t[n]]=!0}(),/**
 * @deprecated May be removed in the next major version
 */ez.isValidJavaScriptVariableName=function(t){return!ez.RESERVED_WORDS[t]&&/^[a-zA-Z_$][0-9a-zA-Z_$]*$/.test(t)},eU.default=ez;var eZ=to(eU=eU.default),eX=to(eg),eY=to(en),e2=es.default.create;function e1(){var t=e2();return t.compile=function(e,n){return function(t,e,n){if(void 0===e&&(e={}),null==t||"string"!=typeof t&&"Program"!==t.type)throw new eD.default("You must pass a string or Handlebars AST to Handlebars.compile. You passed "+t);"data"in(e=b({},e))||(e.data=!0),e.compat&&(e.useDepths=!0);var r=void 0;function i(){var r=n.parse(t,e),i=new n.Compiler().compile(r,e),o=new n.JavaScriptCompiler().compile(i,e,void 0,!0);return n.template(o)}// Template is only compiled on first use and cached after that point.
function o(t,e){return r||(r=i()),r.call(this,t,e)}return o._setup=function(t){return r||(r=i()),r._setup(t)},o._child=function(t,e,n,o){return r||(r=i()),r._child(t,e,n,o)},o}(e,n,t)},t.precompile=function(e,n){return function(t,e,n){if(null==t||"string"!=typeof t&&"Program"!==t.type)throw new eD.default("You must pass a string or Handlebars AST to Handlebars.precompile. You passed "+t);"data"in(e=e||{})||(e.data=!0),e.compat&&(e.useDepths=!0);var r=n.parse(t,e),i=new n.Compiler().compile(r,e);return new n.JavaScriptCompiler().compile(i,e)}(e,n,t)},t.AST=el.default,t.Compiler=eH,t.JavaScriptCompiler=eZ.default,t.Parser=U,t.parse=eR,t.parseWithoutProcessing=eI,t}var e0=e1();e0.create=e1,eY.default(e0),e0.Visitor=eX.default,e0.default=e0,ti.default=e0;var e3=(ti=ti.default).default,e4=(c=eg)&&c.__esModule?c:{default:c};function e8(){this.padding=0}e8.prototype=new e4.default,e8.prototype.pad=function(t){for(var e="",n=0,r=this.padding;n<r;n++)e+="  ";return e+(t+"\n")},e8.prototype.Program=function(t){var e="",n=t.body,r=void 0,i=void 0;if(t.blockParams){var o="BLOCK PARAMS: [";for(r=0,i=t.blockParams.length;r<i;r++)o+=" "+t.blockParams[r];o+=" ]",e+=this.pad(o)}for(r=0,i=n.length;r<i;r++)e+=this.accept(n[r]);return this.padding--,e},e8.prototype.MustacheStatement=function(t){return this.pad("{{ "+this.SubExpression(t)+" }}")},e8.prototype.Decorator=function(t){return this.pad("{{ DIRECTIVE "+this.SubExpression(t)+" }}")},e8.prototype.BlockStatement=e8.prototype.DecoratorBlock=function(t){var e="";return e+=this.pad(("DecoratorBlock"===t.type?"DIRECTIVE ":"")+"BLOCK:"),this.padding++,e+=this.pad(this.SubExpression(t)),t.program&&(e+=this.pad("PROGRAM:"),this.padding++,e+=this.accept(t.program),this.padding--),t.inverse&&(t.program&&this.padding++,e+=this.pad("{{^}}"),this.padding++,e+=this.accept(t.inverse),this.padding--,t.program&&this.padding--),this.padding--,e},e8.prototype.PartialStatement=function(t){var e="PARTIAL:"+t.name.original;return t.params[0]&&(e+=" "+this.accept(t.params[0])),t.hash&&(e+=" "+this.accept(t.hash)),this.pad("{{> "+e+" }}")},e8.prototype.PartialBlockStatement=function(t){var e="PARTIAL BLOCK:"+t.name.original;return t.params[0]&&(e+=" "+this.accept(t.params[0])),t.hash&&(e+=" "+this.accept(t.hash)),e+=" "+this.pad("PROGRAM:"),this.padding++,e+=this.accept(t.program),this.padding--,this.pad("{{> "+e+" }}")},e8.prototype.ContentStatement=function(t){return this.pad("CONTENT[ '"+t.value+"' ]")},e8.prototype.CommentStatement=function(t){return this.pad("{{! '"+t.value+"' }}")},e8.prototype.SubExpression=function(t){for(var e=t.params,n=[],r=void 0,i=0,o=e.length;i<o;i++)n.push(this.accept(e[i]));return e="["+n.join(", ")+"]",r=t.hash?" "+this.accept(t.hash):"",this.accept(t.path)+" "+e+r},e8.prototype.PathExpression=function(t){var e=t.parts.join("/");return(t.data?"@":"")+"PATH:"+e},e8.prototype.StringLiteral=function(t){return'"'+t.value+'"'},e8.prototype.NumberLiteral=function(t){return"NUMBER{"+t.value+"}"},e8.prototype.BooleanLiteral=function(t){return"BOOLEAN{"+t.value+"}"},e8.prototype.UndefinedLiteral=function(){return"UNDEFINED"},e8.prototype.NullLiteral=function(){return"NULL"},e8.prototype.Hash=function(t){for(var e=t.pairs,n=[],r=0,i=e.length;r<i;r++)n.push(this.accept(e[r]));return"HASH{"+n.join(", ")+"}"},e8.prototype.HashPair=function(t){return t.key+"="+this.accept(t.value)},e3.PrintVisitor=e8,e3.print=function(t){return new e8().accept(t)},tr=e3;const e5=((p=tr)&&p.__esModule?p.default:p).template({1:function(t,e,n,r,i){var o,s=null!=e?e:t.nullContext||{},a=t.hooks.helperMissing,u="function",l=t.escapeExpression,c=t.lookupProperty||function(t,e){if(Object.prototype.hasOwnProperty.call(t,e))return t[e]};return'<li>\n    <a href="" target="_blank" rel="noopener noreferrer">\n      <article>\n        <img src="'+l(typeof(o=null!=(o=c(n,"largeImageURL")||(null!=e?c(e,"largeImageURL"):e))?o:a)===u?o.call(s,{name:"largeImageURL",hash:{},data:i,loc:{start:{line:5,column:18},end:{line:5,column:35}}}):o)+'" alt="" width="480">\n        <h2></h2>\n        <p>Posted by: '+l(typeof(o=null!=(o=c(n,"user")||(null!=e?c(e,"user"):e))?o:a)===u?o.call(s,{name:"user",hash:{},data:i,loc:{start:{line:7,column:22},end:{line:7,column:30}}}):o)+"</p>\n        <p>"+l(typeof(o=null!=(o=c(n,"tags")||(null!=e?c(e,"tags"):e))?o:a)===u?o.call(s,{name:"tags",hash:{},data:i,loc:{start:{line:8,column:11},end:{line:8,column:19}}}):o)+"</p>\n      </article>\n    </a>\n</li> \n"},compiler:[8,">= 4.3.0"],main:function(t,e,n,r,i){var o;return null!=(o=(t.lookupProperty||function(t,e){if(Object.prototype.hasOwnProperty.call(t,e))return t[e]})(n,"each").call(null!=e?e:t.nullContext||{},e,{name:"each",hash:{},fn:t.program(1,i,0),inverse:t.noop,data:i,loc:{start:{line:1,column:0},end:{line:12,column:9}}}))?o:""},useData:!0}),e7=document.querySelector(".js-search-form"),e6=document.querySelector(".js-articles-container"),e9=document.querySelector('[data-action="load-more"]'),nt=new class{fetchArticles(t){return fetch(`https://pixabay.com/api/?key=39207227-e0b610c42232251ba1ba1b4e0&q=${this.searchQuery}&image_type=photo&per_page=20&page=${this.page}`).then(t=>t.json()).then(t=>(this.increasePage(),t.hits))}increasePage(){this.page+=1}resetPage(){this.page=1}constructor(){this.searchQuery="",this.page=1}};function ne(t){let e=e5(t);e6.innerHTML=e}//# sourceMappingURL=index.655520e0.js.map
nt.fetchArticles(),e7.addEventListener("submit",function(t){t.preventDefault();let e=t.currentTarget;nt.searchQuery=e.elements.query.value,nt.resetPage(),nt.fetchArticles(searchQuery).then(t=>ne(t))}),e9.addEventListener("click",function(){nt.fetchArticles(searchQuery).then(t=>ne(t))});
//# sourceMappingURL=index.655520e0.js.map
