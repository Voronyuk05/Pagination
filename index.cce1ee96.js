!function(){function t(t,e,n,r){Object.defineProperty(t,e,{get:n,set:r,enumerable:!0,configurable:!0})}var e,n,r,i,o,s,a,u,l,c,p,h,f,d,g,m,v,y,_,S,k,b,P,C,x,L,w,E,A,O,M,N,I,R,B,D,j,$,H,T,U,F,V,G,q,K,W,J,z,Q,Y,X,Z="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},tt={},te={},tn=Z.parcelRequireefa1;function tr(t){return t&&"undefined"!=typeof Symbol&&t.constructor===Symbol?"symbol":typeof t}null==tn&&((tn=function(t){if(t in tt)return tt[t].exports;if(t in te){var e=te[t];delete te[t];var n={id:t,exports:{}};return tt[t]=n,e.call(n.exports,n,n.exports),n.exports}var r=Error("Cannot find module '"+t+"'");throw r.code="MODULE_NOT_FOUND",r}).register=function(t,e){te[t]=e},Z.parcelRequireefa1=tn),tn.register("hTBva",function(e,n){var r,i,o;t(e.exports,"SourceMapGenerator",function(){return r},function(t){return r=t}),t(e.exports,"SourceMapConsumer",function(){return i},function(t){return i=t}),t(e.exports,"SourceNode",function(){return o},function(t){return o=t}),r=tn("8JAU7").SourceMapGenerator,i=tn("4SEMF").SourceMapConsumer,o=tn("fLrsR").SourceNode}),tn.register("8JAU7",function(e,n){t(e.exports,"SourceMapGenerator",function(){return r},function(t){return r=t});var r,i=tn("1d7dz"),o=tn("cUiFn"),s=tn("ccQ4s").ArraySet,a=tn("66k9l").MappingList;/**
 ...
 */u.prototype.toString=function(){return JSON.stringify(this.toJSON())},r=u}),tn.register("1d7dz",function(e,n){t(e.exports,"encode",function(){return r},function(t){return r=t}),t(e.exports,"decode",function(){return i},function(t){return i=t});var r,i,o=tn("ahpWO");r=function(t){var e,n="",r=t<0?(-t<<1)+1:(t<<1)+0;do e=31&r,(r>>>=5)>0&&// continuation bit is marked.
(e|=32),n+=o.encode(e);while(r>0)return n},i=function(t,e,n){var r,i,s,a,u=t.length,l=0,c=0;do{if(e>=u)throw Error("Expected more digits in base 64 VLQ value.");if(-1===(a=o.decode(t.charCodeAt(e++))))throw Error("Invalid base64 digit: "+t.charAt(e-1));s=!!(32&a),a&=31,l+=a<<c,c+=5}while(s)n.value=(i=(r=l)>>1,(1&r)==1?-i:i),n.rest=e}}),tn.register("ahpWO",function(e,n){t(e.exports,"encode",function(){return r},function(t){return r=t}),t(e.exports,"decode",function(){return i},function(t){return i=t});var r,i,o="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".split("");r=function(t){if(0<=t&&t<o.length)return o[t];throw TypeError("Must be between 0 and 63: "+t)},i=function(t){return(// 0 - 25: ABCDEFGHIJKLMNOPQRSTUVWXYZ
...
var i=r.path.lastIndexOf("/");i>=0&&(r.path=r.path.substring(0,i+1))}e=k(_(r),e)}return S(e)}}),tn.register("ccQ4s",function(e,n){t(e.exports,"ArraySet",function(){return r},function(t){return r=t});var r,i=tn("cUiFn"),o=Object.prototype.hasOwnProperty,s="undefined"!=typeof Map;/**
 ...
 */a.prototype.toArray=function(){return this._array.slice()},r=a}),tn.register("66k9l",function(e,n){t(e.exports,"MappingList",function(){return r},function(t){return r=t});var r,i=tn("cUiFn");/**
 ...
 * copy.
 */o.prototype.toArray=function(){return this._sorted||(this._array.sort(i.compareByGeneratedPositionsInflated),this._sorted=!0),this._array},r=o}),tn.register("4SEMF",function(e,n){t(e.exports,"SourceMapConsumer",function(){return r},function(t){return r=t});var r,i=tn("cUiFn"),o=tn("k488Y"),s=tn("ccQ4s").ArraySet,a=tn("1d7dz"),u=tn("hkFn3").quickSort;function l(t,e){var n=t;return"string"==typeof t&&(n=i.parseSourceMapInput(t)),null!=n.sections?new h(n,e):new c(n,e)}/**
...
for(;s-1>=0&&0===n(e[s],e[s-1],!0);)--s;return s}}),tn.register("hkFn3",function(e,n){var r;function i(t,e,n){var r=t[e];t[e]=t[n],t[n]=r}t(e.exports,"quickSort",function(){return r},function(t){return r=t}),r=function(t,e){!/**
...
t(e,n,r,c-1),t(e,n,c+1,o)}}(t,e,0,t.length-1)}}),tn.register("fLrsR",function(e,n){t(e.exports,"SourceNode",function(){return r},function(t){return r=t});var r,i=tn("8JAU7").SourceMapGenerator,o=tn("cUiFn"),s=/(\r?\n)/,a="$$$isSourceNode$$$";/**
 ...
 * map.
 */u.prototype.toStringWithSourceMap=function(t){var e={code:"",line:1,column:0},n=new i(t),r=!1,o=null,s=null,a=null,u=null;return this.walk(function(t,i){e.code+=t,null!==i.source&&null!==i.line&&null!==i.column?((o!==i.source||s!==i.line||a!==i.column||u!==i.name)&&n.addMapping({source:i.source,original:{line:i.line,column:i.column},generated:{line:e.line,column:e.column},name:i.name}),o=i.source,s=i.line,a=i.column,u=i.name,r=!0):r&&(n.addMapping({generated:{line:e.line,column:e.column}}),o=null,r=!1);for(var l=0,c=t.length;l<c;l++)10===t.charCodeAt(l)?(e.line++,e.column=0,l+1===c?(o=null,r=!1):r&&n.addMapping({source:i.source,original:{line:i.line,column:i.column},generated:{line:e.line,column:e.column},name:i.name})):e.column++}),this.walkSourceContents(function(t,e){n.setSourceContent(t,e)}),{code:e.code,map:n}},r=u}),tn.register("1wVs5",function(t,e){});var ti={},to={};// istanbul ignore next
function ts(t){return t&&t.__esModule?t:{default:t}}to.__esModule=!0;var ta={};// istanbul ignore next
function tu(t){return t&&t.__esModule?t:{default:t}}// istanbul ignore next
function tl(t){if(t&&t.__esModule)return t;var e={};if(null!=t)for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e.default=t,e}ta.__esModule=!0;var tc={};// istanbul ignore next
function tp(t){return t&&t.__esModule?t:{default:t}}t(tc,"__esModule",function(){return h},function(t){return h=t}),t(tc,"HandlebarsEnvironment",function(){return f},function(t){return f=t}),t(tc,"VERSION",function(){return d},function(t){return d=t}),t(tc,"COMPILER_REVISION",function(){return g},function(t){return g=t}),t(tc,"LAST_COMPATIBLE_COMPILER_REVISION",function(){return m},function(t){return m=t}),t(tc,"REVISION_CHANGES",function(){return v},function(t){return v=t}),t(tc,"log",function(){return y},function(t){return y=t}),t(tc,"createFrame",function(){return _},function(t){return _=t}),t(tc,"logger",function(){return S},function(t){return S=t}),h=!0,f=tZ;var th={};t(th,"__esModule",function(){return k},function(t){return k=t}),t(th,"extend",function(){return b},function(t){return b=t}),t(th,"indexOf",function(){return P},function(t){return P=t}),t(th,"escapeExpression",function(){return C},function(t){return C=t}),t(th,"isEmpty",function(){return x},function(t){return x=t}),t(th,"createFrame",function(){return L},function(t){return L=t}),t(th,"blockParams",function(){return w},function(t){return w=t}),t(th,"appendContextPath",function(){return E},function(t){return E=t}),t(th,"toString",function(){return A},function(t){return A=t}),t(th,"isFunction",function(){return O},function(t){return O=t}),t(th,"isArray",function(){return M},function(t){return M=t}),k=!0,b=tv,P=// Older IE versions do not directly support indexOf so we must implement our own, sadly.
function(t,e){for(var n=0,r=t.length;n<r;n++)if(t[n]===e)return n;return -1},C=function(t){if("string"!=typeof t){// don't escape SafeStrings, since they're already safe
...
t=""+t}return tg.test(t)?t.replace(td,tm):t},x=function(t){return!t&&0!==t||!!tS(t)&&0===t.length},L=function(t){var e=tv({},t);return e._parent=t,e},w=function(t,e){return t.path=e,t},E=function(t,e){return(t?t+".":"")+e};var tf={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","`":"&#x60;","=":"&#x3D;"},td=/[&<>"'`=]/g,tg=/[&<>"'`=]/;function tm(t){return tf[t]}function tv(t/* , ...source */){for(var e=1;e<arguments.length;e++)for(var n in arguments[e])Object.prototype.hasOwnProperty.call(arguments[e],n)&&(t[n]=arguments[e][n]);return t}var ty=Object.prototype.toString;A=ty;// Sourced from lodash
// https://github.com/bestiejs/lodash/blob/master/LICENSE.txt
/* eslint-disable func-style */var t_=function(t){return"function"==typeof t};t_(/x/)&&(O=t_=function(t){return"function"==typeof t&&"[object Function]"===ty.call(t)}),O=t_;/* eslint-enable func-style *//* istanbul ignore next */var tS=Array.isArray||function(t){return!!t&&"object"==typeof t&&"[object Array]"===ty.call(t)};M=tS;var tk={};tk.__esModule=!0;var tb=["description","fileName","lineNumber","endLineNumber","message","name","number","stack"];function tP(t,e){var n=e&&e.loc,r=void 0,i=void 0,o=void 0,s=void 0;n&&(r=n.start.line,i=n.end.line,o=n.start.column,s=n.end.column,t+=" - "+r+":"+o);// Unfortunately errors are not enumerable in Chrome (at least), so `for prop in tmp` doesn't work.
for(var a=Error.prototype.constructor.call(this,t),u=0;u<tb.length;u++)this[tb[u]]=a[tb[u]];/* istanbul ignore else */Error.captureStackTrace&&Error.captureStackTrace(this,tP);try{n&&(this.lineNumber=r,this.endLineNumber=i,Object.defineProperty?(Object.defineProperty(this,"column",{value:o,enumerable:!0}),Object.defineProperty(this,"endColumn",{value:s,enumerable:!0})):(this.column=o,this.endColumn=s))}catch(t){/* Ignore if the browser is very particular */}}tP.prototype=Error(),tk.default=tP;var tC=tp(tk=tk.default);// istanbul ignore next
function tx(t){return t&&t.__esModule?t:{default:t}}N=function(t,e,n){t.helpers[e]&&(t.hooks[e]=t.helpers[e],n||delete t.helpers[e])};var tL={};tL.__esModule=!0,tL.default=function(t){t.registerHelper("blockHelperMissing",function(e,n){var r=n.inverse,i=n.fn;if(!0===e)return i(this);if(!1===e||null==e)return r(this);if(M(e))return e.length>0?(n.ids&&(n.ids=[n.name]),t.helpers.each(e,n)):r(this);if(n.data&&n.ids){var o=L(n.data);o.contextPath=E(n.data.contextPath,n.name),n={data:o}}return i(e,n)})};var tw=tx(tL=tL.default),tE={};tE.__esModule=!0;var tA=(e=tk)&&e.__esModule?e:{default:e};tE.default=function(t){t.registerHelper("each",function(t,e){if(!e)throw new tA.default("Must pass iterator to #each");var n=e.fn,r=e.inverse,i=0,o="",s=void 0,a=void 0;function u(e,r,i){s&&(s.key=e,s.index=r,s.first=0===r,s.last=!!i,a&&(s.contextPath=a+e)),o+=n(t[e],{data:s,blockParams:w([t[e],e],[a+e,null])})}if(e.data&&e.ids&&(a=E(e.data.contextPath,e.ids[0])+"."),O(t)&&(t=t.call(this)),e.data&&(s=L(e.data)),t&&"object"==typeof t){if(M(t))for(var l,c=t.length;i<c;i++)i in t&&u(i,i,i===t.length-1);else if(Z.Symbol&&t[Z.Symbol.iterator]){for(var p=[],h=t[Z.Symbol.iterator](),f=h.next();!f.done;f=h.next())p.push(f.value);t=p;for(var c=t.length;i<c;i++)u(i,i,i===t.length-1)}else l=void 0,Object.keys(t).forEach(function(t){void 0!==l&&u(l,i-1),l=t,i++}),void 0!==l&&u(l,i-1,!0)}return 0===i&&(o=r(this)),o})};var tO=tx(tE=tE.default),tM={};tM.__esModule=!0;var tN=(n=tk)&&n.__esModule?n:{default:n};tM.default=function(t){t.registerHelper("helperMissing",function()/* [args, ]options */{if(1!=arguments.length)throw new tN.default('Missing helper: "'+arguments[arguments.length-1].name+'"')})};var tI=tx(tM=tM.default),tR={};tR.__esModule=!0;var tB=(r=tk)&&r.__esModule?r:{default:r};tR.default=function(t){t.registerHelper("if",function(t,e){if(2!=arguments.length)throw new tB.default("#if requires exactly one argument");return(// Default behavior is to render the positive path if the value is truthy and not empty.
// The `includeZero` option may be set to treat the condtional as purely not empty based on the
// behavior of isEmpty. Effectively this determines if 0 is handled by the positive path or negative.
(O(t)&&(t=t.call(this)),!e.hash.includeZero&&!t||x(t))?e.inverse(this):e.fn(this))}),t.registerHelper("unless",function(e,n){if(2!=arguments.length)throw new tB.default("#unless requires exactly one argument");return t.helpers.if.call(this,e,{fn:n.inverse,inverse:n.fn,hash:n.hash})})};var tD=tx(tR=tR.default),tj={};tj.__esModule=!0,tj.default=function(t){t.registerHelper("log",function()/* message, options */{for(var e=[void 0],n=arguments[arguments.length-1],r=0;r<arguments.length-1;r++)e.push(arguments[r]);var i=1;null!=n.hash.level?i=n.hash.level:n.data&&null!=n.data.level&&(i=n.data.level),e[0]=i,t.log.apply(t,e)})};var t$=tx(tj=tj.default),tH={};tH.__esModule=!0,tH.default=function(t){t.registerHelper("lookup",function(t,e,n){return t?n.lookupProperty(t,e):t})};var tT=tx(tH=tH.default),tU={};tU.__esModule=!0;var tF=(i=tk)&&i.__esModule?i:{default:i};tU.default=function(t){t.registerHelper("with",function(t,e){if(2!=arguments.length)throw new tF.default("#with requires exactly one argument");O(t)&&(t=t.call(this));var n=e.fn;if(x(t))return e.inverse(this);var r=e.data;return e.data&&e.ids&&((r=L(e.data)).contextPath=E(e.data.contextPath,e.ids[0])),n(t,{data:r,blockParams:w([t],[r&&r.contextPath])})})};var tV=tx(tU=tU.default),tG={};tG.__esModule=!0,tG.default=function(t){t.registerDecorator("inline",function(t,e,n,r){var i=t;return e.partials||(e.partials={},i=function(r,i){// Create a new partials stack frame prior to exec.
var o=n.partials;n.partials=b({},o,e.partials);var s=t(r,i);return n.partials=o,s}),e.partials[r.args[0]]=r.fn,i})};var tq=(o=tG=tG.default)&&o.__esModule?o:{default:o},tK={};tK.__esModule=!0;var tW={methodMap:["debug","info","warn","error"],level:"info",// Maps a given level value to the `methodMap` indexes above.
lookupLevel:function(t){if("string"==typeof t){var e=P(tW.methodMap,t.toLowerCase());t=e>=0?e:parseInt(t,10)}return t},// Can be overridden in the host environment
log:function(t){if(t=tW.lookupLevel(t),"undefined"!=typeof console&&tW.lookupLevel(tW.level)<=t){var e=tW.methodMap[t];// eslint-disable-next-line no-console
...
}}};tK.default=tW;var tJ=tp(tK=tK.default);I=/**
 * Create a new object with "null"-prototype to avoid truthy results on prototype properties.
 * The resulting object can be used with "object[property]" to check if a property exists
 * @param {...object} sources a varargs parameter of source objects that will be merged
 * @returns {object}
 */function(){for(var t=arguments.length,e=Array(t),n=0;n<t;n++)e[n]=arguments[n];return b.apply(void 0,[Object.create(null)].concat(e))};var tz=// istanbul ignore next
function(t){if(t&&t.__esModule)return t;var e={};if(null!=t)for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e.default=t,e}(tK),tQ=Object.create(null);function tY(t,e){return void 0!==t.whitelist[e]?!0===t.whitelist[e]:void 0!==t.defaultValue?t.defaultValue:(!0!==tQ[e]&&(tQ[e]=!0,tz.log("error",'Handlebars: Access has been denied to resolve the property "'+e+'" because it is not an "own property" of its parent.\nYou can add a runtime option to disable the check or this warning:\nSee https://handlebarsjs.com/api-reference/runtime-options.html#options-to-control-prototype-access for details')),!1)}d="4.7.7",g=8,m=7,v={1:"<= 1.0.rc.2",2:"== 1.0.0-rc.3",3:"== 1.0.0-rc.4",4:"== 1.x.x",5:"== 2.0.0-alpha.x",6:">= 2.0.0-beta.1",7:">= 4.0.0 <4.3.0",8:">= 4.3.0"};var tX="[object Object]";function tZ(t,e,n){this.helpers=t||{},this.partials=e||{},this.decorators=n||{},tw.default(this),tO.default(this),tI.default(this),tD.default(this),t$.default(this),tT.default(this),tV.default(this),tq.default(this)}tZ.prototype={constructor:tZ,logger:tJ.default,log:tJ.default.log,registerHelper:function(t,e){if(A.call(t)===tX){if(e)throw new tC.default("Arg not supported with multiple helpers");b(this.helpers,t)}else this.helpers[t]=e},unregisterHelper:function(t){delete this.helpers[t]},registerPartial:function(t,e){if(A.call(t)===tX)b(this.partials,t);else{if(void 0===e)throw new tC.default('Attempting to register a partial called "'+t+'" as undefined');this.partials[t]=e}},unregisterPartial:function(t){delete this.partials[t]},registerDecorator:function(t,e){if(A.call(t)===tX){if(e)throw new tC.default("Arg not supported with multiple decorators");b(this.decorators,t)}else this.decorators[t]=e},unregisterDecorator:function(t){delete this.decorators[t]},/**
   * Reset the memory of illegal property accesses that have already been logged.
   * @deprecated should only be used in handlebars test-cases
   */resetLoggedPropertyAccesses:function(){Object.keys(tQ).forEach(function(t){delete tQ[t]})}},y=tJ.default.log,_=L,S=tJ.default;var t2=tl(tc),t1={};function t0(t){this.string=t}t1.__esModule=!0,t0.prototype.toString=t0.prototype.toHTML=function(){return""+this.string},t1.default=t0;var t3=tu(t1=t1.default),t4=tu(tk),t8=tl(th),t5={};t(t5,"__esModule",function(){return R},function(t){return R=t}),t(t5,"checkRevision",function(){return B},function(t){return B=t}),t(t5,"template",function(){return D},function(t){return D=t}),t(t5,"wrapProgram",function(){return j},function(t){return j=t}),t(t5,"resolvePartial",function(){return $},function(t){return $=t}),t(t5,"invokePartial",function(){return H},function(t){return H=t}),t(t5,"noop",function(){return T},function(t){return T=t}),R=!0,B=function(t){var e=t&&t[0]||1,n=g;if(!(e>=m)||!(e<=g)){if(e<m){var r=v[n],i=v[e];throw new t6.default("Template was precompiled with an older version of Handlebars than the current runtime. Please update your precompiler to a newer version ("+r+") or downgrade your runtime to an older version ("+i+").")}throw new t6.default("Template was precompiled with a newer version of Handlebars than the current runtime. Please update your runtime to a newer version ("+t[1]+").")}},D=function(t,e){/* istanbul ignore next */if(!e)throw new t6.default("No environment passed to template");if(!t||!t.main)throw new t6.default("Unknown template object: "+(void 0===t?"undefined":tr(t)));t.main.decorator=t.main_d,// Note: Using env.VM references rather than local var references throughout this section to allow
...
var n=t.compiler&&7===t.compiler[0],r={strict:function(t,e,n){if(!t||!(e in t))throw new t6.default('"'+e+'" not defined in '+t,{loc:n});return r.lookupProperty(t,e)},lookupProperty:function(t,e){var n,i=t[e];if(null==i||Object.prototype.hasOwnProperty.call(t,e)||(n=r.protoAccessControl,"function"==typeof i?tY(n.methods,e):tY(n.properties,e)))return i},lookup:function(t,e){for(var n=t.length,i=0;i<n;i++)if(null!=(t[i]&&r.lookupProperty(t[i],e)))return t[i][e]},lambda:function(t,e){return"function"==typeof t?t.call(e):t},escapeExpression:t7.escapeExpression,invokePartial:function(n,r,i){i.hash&&(r=t7.extend({},r,i.hash),i.ids&&(i.ids[0]=!0)),n=e.VM.resolvePartial.call(this,n,r,i);var o=t7.extend({},i,{hooks:this.hooks,protoAccessControl:this.protoAccessControl}),s=e.VM.invokePartial.call(this,n,r,o);if(null==s&&e.compile&&(i.partials[i.name]=e.compile(n,t.compilerOptions,e),s=i.partials[i.name](r,o)),null!=s){if(i.indent){for(var a=s.split("\n"),u=0,l=a.length;u<l&&(a[u]||u+1!==l);u++)a[u]=i.indent+a[u];s=a.join("\n")}return s}throw new t6.default("The partial "+i.name+" could not be compiled when running in runtime-only mode")},fn:function(e){var n=t[e];return n.decorator=t[e+"_d"],n},programs:[],program:function(t,e,n,r,i){var o=this.programs[t],s=this.fn(t);return e||i||r||n?o=t9(this,t,s,e,n,r,i):o||(o=this.programs[t]=t9(this,t,s)),o},data:function(t,e){for(;t&&e--;)t=t._parent;return t},mergeIfNeeded:function(t,e){var n=t||e;return t&&e&&t!==e&&(n=t7.extend({},e,t)),n},// An empty object to use as replacement for null-contexts
nullContext:Object.seal({}),noop:e.VM.noop,compilerInfo:t.compiler};function i(e){var n,o=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],s=o.data;i._setup(o),!o.partial&&t.useData&&((n=s)&&"root"in n||((n=n?_(n):{}).root=e),s=n);var a=void 0,u=t.useBlockParams?[]:void 0;function l(e/*, options*/){return""+t.main(r,e,r.helpers,r.partials,s,u,a)}return t.useDepths&&(a=o.depths?e!=o.depths[0]?[e].concat(o.depths):o.depths:[e]),(l=ee(t.main,l,r,o.depths||[],s,u))(e,o)}return i.isTop=!0,i._setup=function(i){if(i.partial)r.protoAccessControl=i.protoAccessControl,r.helpers=i.helpers,r.partials=i.partials,r.decorators=i.decorators,r.hooks=i.hooks;else{var o,s,a=t7.extend({},e.helpers,i.helpers);(function(t,e){Object.keys(t).forEach(function(n){var r,i=t[n];t[n]=(r=e.lookupProperty,"function"!=typeof i?i:function()/* dynamic arguments */{var t,e=arguments[arguments.length-1];return arguments[arguments.length-1]=(t=e,t7.extend({lookupProperty:r},t)),i.apply(this,arguments)})})})(a,r),r.helpers=a,t.usePartial&&(r.partials=r.mergeIfNeeded(i.partials,e.partials)),(t.usePartial||t.useDecorators)&&(r.decorators=t7.extend({},e.decorators,i.decorators)),r.hooks={},r.protoAccessControl=((o=Object.create(null)).constructor=!1,o.__defineGetter__=!1,o.__defineSetter__=!1,o.__lookupGetter__=!1,// eslint-disable-next-line no-proto
(s=Object.create(null)).__proto__=!1,{properties:{whitelist:I(s,i.allowedProtoProperties),defaultValue:i.allowProtoPropertiesByDefault},methods:{whitelist:I(o,i.allowedProtoMethods),defaultValue:i.allowProtoMethodsByDefault}});var u=i.allowCallsToHelperMissing||n;N(r,"helperMissing",u),N(r,"blockHelperMissing",u)}},i._child=function(e,n,i,o){if(t.useBlockParams&&!i)throw new t6.default("must pass block params");if(t.useDepths&&!o)throw new t6.default("must pass parent depths");return t9(r,e,t[e],n,0,i,o)},i},j=t9,$=/**
 * This is currently part of the official API, therefore implementation details should not be changed.
 */function(t,e,n){return t?t.call||n.name||(// This is a dynamic partial that returned a string
n.name=t,t=n.partials[t]):t="@partial-block"===n.name?n.data["partial-block"]:n.partials[n.name],t},H=function(t,e,n){// Use the current closure context to save the partial-block if this partial
var r,i=n.data&&n.data["partial-block"];n.partial=!0,n.ids&&(n.data.contextPath=n.ids[0]||n.data.contextPath);var o=void 0;if(n.fn&&n.fn!==et&&(n.data=_(n.data),r=n.fn,o=n.data["partial-block"]=function(t){var e=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];return(// Restore the partial-block from the closure for the execution of the block
// i.e. the part inside the block of the partial call.
e.data=_(e.data),e.data["partial-block"]=i,r(t,e))},r.partials&&(n.partials=t7.extend({},n.partials,r.partials))),void 0===t&&o&&(t=o),void 0===t)throw new t6.default("The partial "+n.name+" could not be found");if(t instanceof Function)return t(e,n)},T=et;var t7=// istanbul ignore next
function(t){if(t&&t.__esModule)return t;var e={};if(null!=t)for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e.default=t,e}(th),t6=(s=tk)&&s.__esModule?s:{default:s};function t9(t,e,n,r,i,o,s){function a(e){var i=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],a=s;return s&&e!=s[0]&&!(e===t.nullContext&&null===s[0])&&(a=[e].concat(s)),n(t,e,t.helpers,t.partials,i.data||r,o&&[i.blockParams].concat(o),a)}return(a=ee(n,a,t,s,r,o)).program=e,a.depth=s?s.length:0,a.blockParams=i||0,a}function et(){return""}function ee(t,e,n,r,i,o){if(t.decorator){var s={};e=t.decorator(e,s,n,r&&r[0],i,o,r),t7.extend(e,s)}return e}var en=tl(t5),er={};er.__esModule=!0,er.default=function(t){/* istanbul ignore next */var e=void 0!==Z?Z:window,n=e.Handlebars;/* istanbul ignore next */t.noConflict=function(){return e.Handlebars===t&&(e.Handlebars=n),t}};var ei=tu(er=er.default);// For compatibility and usage outside of module systems, make the Handlebars object a namespace
function eo(){var t=new t2.HandlebarsEnvironment;return t8.extend(t,t2),t.SafeString=t3.default,t.Exception=t4.default,t.Utils=t8,t.escapeExpression=t8.escapeExpression,t.VM=en,t.template=function(e){return en.template(e,t)},t}var es=eo();es.create=eo,ei.default(es),es.default=es,ta.default=es;var ea=ts(ta=ta.default),eu={};eu.__esModule=!0;var el={// Public API used to evaluate derived attributes regarding AST nodes
...
if(n&&!ey.prototype[n.type])throw new ev.default('Unexpected node type "'+n.type+'" found when accepting '+e+" on "+t.type);t[e]=n}},// Performs an accept operation with added sanity check to ensure
// required keys are not removed.
acceptRequired:function(t,e){if(this.acceptKey(t,e),!t[e])throw new ev.default(t.type+" requires "+e)},// Traverses a given array. If mutating, empty respnses will be removed
// for child elements.
acceptArray:function(t){for(var e=0,n=t.length;e<n;e++)this.acceptKey(t,e),!t[e]&&(t.splice(e,1),e--,n--)},accept:function(t){if(t){/* istanbul ignore next: Sanity code */if(!this[t.type])throw new ev.default("Unknown type: "+t.type,t);this.current&&this.parents.unshift(this.current),this.current=t;var e=this[t.type](t);if(this.current=this.parents.shift(),!this.mutating||e)return e;if(!1!==e)return t}},Program:function(t){this.acceptArray(t.body)},MustacheStatement:e_,Decorator:e_,BlockStatement:eS,DecoratorBlock:eS,PartialStatement:ek,PartialBlockStatement:function(t){ek.call(this,t),this.acceptKey(t,"program")},ContentStatement:function()/* content */{},CommentStatement:function()/* comment */{},SubExpression:e_,PathExpression:function()/* path */{},StringLiteral:function()/* string */{},NumberLiteral:function()/* number */{},BooleanLiteral:function()/* bool */{},UndefinedLiteral:function()/* literal */{},NullLiteral:function()/* literal */{},Hash:function(t){this.acceptArray(t.pairs)},HashPair:function(t){this.acceptRequired(t,"value")}},em.default=ey;var eb=(u=em=em.default)&&u.__esModule?u:{default:u};function eP(){var t=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];this.options=t}function eC(t,e,n){void 0===e&&(e=t.length);// Nodes that end with newlines are considered whitespace (but are special
// cased for strip operations)
var r=t[e-1],i=t[e-2];return r?"ContentStatement"===r.type?(i||!n?/\r?\n\s*?$/:/(^|\r?\n)\s*?$/).test(r.original):void 0:n}function ex(t,e,n){void 0===e&&(e=-1);var r=t[e+1],i=t[e+2];return r?"ContentStatement"===r.type?(i||!n?/^\s*?\r?\n/:/^\s*?(\r?\n|$)/).test(r.original):void 0:n}// Marks the node to the right of the position as omitted.
...
// content is met.
function eL(t,e,n){var r=t[null==e?0:e+1];if(r&&"ContentStatement"===r.type&&(n||!r.rightStripped)){var i=r.value;r.value=r.value.replace(n?/^\s+/:/^[ \t]*\r?\n?/,""),r.rightStripped=r.value!==i}}// Marks the node to the left of the position as omitted.
// I.e. ' '{{foo}} will mark the ' ' node as omitted.
//
...
// If mulitple is truthy then all whitespace will be stripped out until non-whitespace
// content is met.
function ew(t,e,n){var r=t[null==e?t.length-1:e-1];if(r&&"ContentStatement"===r.type&&(n||!r.leftStripped)){// We omit the last node if it's whitespace only and not preceded by a non-content node.
var i=r.value;return r.value=r.value.replace(n?/\s+$/:/[ \t]+$/,""),r.leftStripped=r.value!==i,r.leftStripped}}eP.prototype=new eb.default,eP.prototype.Program=function(t){var e=!this.options.ignoreStandalone,n=!this.isRootSeen;this.isRootSeen=!0;for(var r=t.body,i=0,o=r.length;i<o;i++){var s=r[i],a=this.accept(s);if(a){var u=eC(r,i,n),l=ex(r,i,n),c=a.openStandalone&&u,p=a.closeStandalone&&l,h=a.inlineStandalone&&u&&l;a.close&&eL(r,i,!0),a.open&&ew(r,i,!0),e&&h&&(eL(r,i),ew(r,i)&&"PartialStatement"===s.type&&(s.indent=/([ \t]+$)/.exec(r[i-1].original)[1])),e&&c&&(eL((s.program||s.inverse).body),// Strip out the previous content node if it's whitespace only
ew(r,i)),e&&p&&(// Always strip the next node
eL(r,i),ew((s.inverse||s.program).body))}}return t},eP.prototype.BlockStatement=eP.prototype.DecoratorBlock=eP.prototype.PartialBlockStatement=function(t){this.accept(t.program),this.accept(t.inverse);// Find the inverse program that is involed with whitespace stripping.
...
openStandalone:ex(e.body),closeStandalone:eC((r||e).body)};if(t.openStrip.close&&eL(e.body,null,!0),n){var s=t.inverseStrip;s.open&&ew(e.body,null,!0),s.close&&eL(r.body,null,!0),t.closeStrip.open&&ew(i.body,null,!0),!this.options.ignoreStandalone&&eC(e.body)&&ex(r.body)&&(ew(e.body),eL(r.body))}else t.closeStrip.open&&ew(e.body,null,!0);return o},eP.prototype.Decorator=eP.prototype.MustacheStatement=function(t){return t.strip},eP.prototype.PartialStatement=eP.prototype.CommentStatement=function(t){/* istanbul ignore next */var e=t.strip||{};return{inlineStandalone:!0,open:e.open,close:e.close}},eg.default=eP;var eE=ep(eg=eg.default),eA={};t(eA,"__esModule",function(){return F},function(t){return F=t}),t(eA,"SourceLocation",function(){return V},function(t){return V=t}),t(eA,"id",function(){return G},function(t){return G=t}),t(eA,"stripFlags",function(){return q},function(t){return q=t}),t(eA,"stripComment",function(){return K},function(t){return K=t}),t(eA,"preparePath",function(){return W},function(t){return W=t}),t(eA,"prepareMustache",function(){return J},function(t){return J=t}),t(eA,"prepareRawBlock",function(){return z},function(t){return z=t}),t(eA,"prepareBlock",function(){return Q},function(t){return Q=t}),t(eA,"prepareProgram",function(){return Y},function(t){return Y=t}),t(eA,"preparePartialBlock",function(){return X},function(t){return X=t}),F=!0,V=function(t,e){this.source=t,this.start={line:e.first_line,column:e.first_column},this.end={line:e.last_line,column:e.last_column}},G=function(t){return/^\[.*\]$/.test(t)?t.substring(1,t.length-1):t},q=function(t,e){return{open:"~"===t.charAt(2),close:"~"===e.charAt(e.length-3)}},K=function(t){return t.replace(/^\{\{~?!-?-?/,"").replace(/-?-?~?\}\}$/,"")},W=function(t,e,n){n=this.locInfo(n);for(var r=t?"@":"",i=[],o=0,s=0,a=e.length;s<a;s++){var u=e[s].part,// i.e. foo.[this] resolves to approximately context.foo['this']
l=e[s].original!==u;if(r+=(e[s].separator||"")+u,l||".."!==u&&"."!==u&&"this"!==u)i.push(u);else{if(i.length>0)throw new eO.default("Invalid path: "+r,{loc:n});".."===u&&o++}}return{type:"PathExpression",data:t,depth:o,parts:i,original:r,loc:n}},J=function(t,e,n,r,i,o){// Must use charAt to support IE pre-10
var s=r.charAt(3)||r.charAt(2);return{type:/\*/.test(r)?"Decorator":"MustacheStatement",path:t,params:e,hash:n,escaped:"{"!==s&&"&"!==s,strip:i,loc:this.locInfo(o)}},z=function(t,e,n,r){eM(t,n);var i={type:"Program",body:e,strip:{},loc:r=this.locInfo(r)};return{type:"BlockStatement",path:t.path,params:t.params,hash:t.hash,program:i,openStrip:{},inverseStrip:{},closeStrip:{},loc:r}},Q=function(t,e,n,r,i,o){r&&r.path&&eM(t,r);var s=/\*/.test(t.open);e.blockParams=t.blockParams;var a=void 0,u=void 0;if(n){if(s)throw new eO.default("Unexpected inverse block on decorator",n);n.chain&&(n.program.body[0].closeStrip=r.strip),u=n.strip,a=n.program}return i&&(i=a,a=e,e=i),{type:s?"DecoratorBlock":"BlockStatement",path:t.path,params:t.params,hash:t.hash,program:e,inverse:a,openStrip:t.strip,inverseStrip:u,closeStrip:r&&r.strip,loc:this.locInfo(o)}},Y=function(t,e){if(!e&&t.length){var n=t[0].loc,r=t[t.length-1].loc;/* istanbul ignore else */n&&r&&(e={source:n.source,start:{line:n.start.line,column:n.start.column},end:{line:r.end.line,column:r.end.column}})}return{type:"Program",body:t,strip:{},loc:e}},X=function(t,e,n,r){return eM(t,n),{type:"PartialBlockStatement",name:t.path,params:t.params,hash:t.hash,program:e,openStrip:t.strip,closeStrip:n&&n.strip,loc:this.locInfo(r)}};var eO=(l=tk)&&l.__esModule?l:{default:l};function eM(t,e){if(e=e.path?e.path.original:e,t.path.original!==e){var n={loc:t.path.loc};throw new eO.default(t.path.original+" doesn't match "+e,n)}}var eN=// istanbul ignore next
function(t){if(t&&t.__esModule)return t;var e={};if(null!=t)for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e.default=t,e}(eA);U=ed.default;var eI={};function eR(t,e){return(// Just return if an already-compiled AST was passed in.
"Program"===t.type?t:(ed.default.yy=eI,// Altering the shared object here, but this is ok as parser is a sync operation
eI.locInfo=function(t){return new eI.SourceLocation(e&&e.srcName,t)},ed.default.parse(t)))}function eB(t,e){var n=eR(t,e);return new eE.default(e).accept(n)}// istanbul ignore next
function eD(t){return t&&t.__esModule?t:{default:t}}b(eI,eN);var ej=eD(tk),e$=eD(eu),eH=[].slice;function eT(){}function eU(t){if(!t.path.parts){var e=t.path;// Casting to string here to make false and 0 literal values play nicely with the rest
// of the system.
...
// evaluate it by executing `blockHelperMissing`
this.opcode("pushProgram",e),this.opcode("pushProgram",n),this.opcode("emptyHash"),this.opcode("ambiguousBlockValue")),this.opcode("append")},DecoratorBlock:function(t){var e=t.program&&this.compileProgram(t.program),n=this.setupFullMustacheParams(t,e,void 0),r=t.path;this.useDecorators=!0,this.opcode("registerDecorator",n.length,r.original)},PartialStatement:function(t){this.usePartial=!0;var e=t.program;e&&(e=this.compileProgram(t.program));var n=t.params;if(n.length>1)throw new ej.default("Unsupported number of partial arguments: "+n.length,t);n.length||(this.options.explicitPartialContext?this.opcode("pushLiteral","undefined"):n.push({type:"PathExpression",parts:[],depth:0}));var r=t.name.original,i="SubExpression"===t.name.type;i&&this.accept(t.name),this.setupFullMustacheParams(t,e,void 0,!0);var o=t.indent||"";this.options.preventIndent&&o&&(this.opcode("appendContent",o),o=""),this.opcode("invokePartial",i,r,o),this.opcode("append")},PartialBlockStatement:function(t){this.PartialStatement(t)},MustacheStatement:function(t){this.SubExpression(t),t.escaped&&!this.options.noEscape?this.opcode("appendEscaped"):this.opcode("append")},Decorator:function(t){this.DecoratorBlock(t)},ContentStatement:function(t){t.value&&this.opcode("appendContent",t.value)},CommentStatement:function(){},SubExpression:function(t){eU(t);var e=this.classifySexpr(t);"simple"===e?this.simpleSexpr(t):"helper"===e?this.helperSexpr(t):this.ambiguousSexpr(t)},ambiguousSexpr:function(t,e,n){var r=t.path,i=r.parts[0],o=null!=e||null!=n;this.opcode("getContext",r.depth),this.opcode("pushProgram",e),this.opcode("pushProgram",n),r.strict=!0,this.accept(r),this.opcode("invokeAmbiguous",i,o)},simpleSexpr:function(t){var e=t.path;e.strict=!0,this.accept(e),this.opcode("resolvePossibleLambda")},helperSexpr:function(t,e,n){var r=this.setupFullMustacheParams(t,e,n),i=t.path,o=i.parts[0];if(this.options.knownHelpers[o])this.opcode("invokeKnownHelper",r.length,o);else if(this.options.knownHelpersOnly)throw new ej.default("You specified knownHelpersOnly, but used the unknown helper "+o,t);else i.strict=!0,i.falsy=!0,this.accept(i),this.opcode("invokeHelper",r.length,i.original,e$.default.helpers.simpleId(i))},PathExpression:function(t){this.addDepth(t.depth),this.opcode("getContext",t.depth);var e=t.parts[0],n=e$.default.helpers.scopedId(t),r=!t.depth&&!n&&this.blockParamIndex(e);r?this.opcode("lookupBlockParam",r,t.parts):e?t.data?(this.options.data=!0,this.opcode("lookupData",t.depth,t.parts,t.strict)):this.opcode("lookupOnContext",t.parts,t.falsy,t.strict,n):this.opcode("pushContext")},StringLiteral:function(t){this.opcode("pushString",t.value)},NumberLiteral:function(t){this.opcode("pushLiteral",t.value)},BooleanLiteral:function(t){this.opcode("pushLiteral",t.value)},UndefinedLiteral:function(){this.opcode("pushLiteral","undefined")},NullLiteral:function(){this.opcode("pushLiteral","null")},Hash:function(t){var e=t.pairs,n=0,r=e.length;for(this.opcode("pushHash");n<r;n++)this.pushParam(e[n].value);for(;n--;)this.opcode("assignToHash",e[n].key);this.opcode("popHash")},// HELPERS
opcode:function(t){this.opcodes.push({opcode:t,args:eH.call(arguments,1),loc:this.sourceNode[0].loc})},addDepth:function(t){t&&(this.useDepths=!0)},classifySexpr:function(t){var e=e$.default.helpers.simpleId(t.path),n=e&&!!this.blockParamIndex(t.path.parts[0]),r=!n&&e$.default.helpers.helperExpression(t),i=!n&&(r||e);// if ambiguous, we can possibly resolve the ambiguity now
...
this.accept(t);else{if(this.trackIds){var n=void 0;if(!t.parts||e$.default.helpers.scopedId(t)||t.depth||(n=this.blockParamIndex(t.parts[0])),n){var r=t.parts.slice(1).join(".");this.opcode("pushId","BlockParam",n,r)}else(e=t.original||e).replace&&(e=e.replace(/^this(?:\.|$)/,"").replace(/^\.\//,"").replace(/^\.$/,"")),this.opcode("pushId",t.type,e)}this.accept(t)}},setupFullMustacheParams:function(t,e,n,r){var i=t.params;return this.pushParams(i),this.opcode("pushProgram",e),this.opcode("pushProgram",n),t.hash?this.accept(t.hash):this.opcode("emptyHash",r),i},blockParamIndex:function(t){for(var e=0,n=this.options.blockParams.length;e<n;e++){var r=this.options.blockParams[e],i=r&&P(r,t);if(r&&i>=0)return[e,i]}}};var eF={};// istanbul ignore next
function eV(t){return t&&t.__esModule?t:{default:t}}eF.__esModule=!0;var eG=eV(tk),eq={};eq.__esModule=!0;var eK=void 0;try{/* istanbul ignore next */"function"==typeof define&&define.amd||(eK=tn("hTBva").SourceNode)}catch(t){}function eW(t,e,n){if(M(t)){for(var r=[],i=0,o=t.length;i<o;i++)r.push(e.wrap(t[i],n));return r}return"boolean"==typeof t||"number"==typeof t?t+"":t}function eJ(t){this.srcFile=t,this.source=[]}eK||/* istanbul ignore next */((eK=function(t,e,n,r){this.src="",r&&this.add(r)}).prototype={add:function(t){M(t)&&(t=t.join("")),this.src+=t},prepend:function(t){M(t)&&(t=t.join("")),this.src=t+this.src},toStringWithSourceMap:function(){return{code:this.toString()}},toString:function(){return this.src}}),eJ.prototype={isEmpty:function(){return!this.source.length},prepend:function(t,e){this.source.unshift(this.wrap(t,e))},push:function(t,e){this.source.push(this.wrap(t,e))},merge:function(){var t=this.empty();return this.each(function(e){t.add(["  ",e,"\n"])}),t},each:function(t){for(var e=0,n=this.source.length;e<n;e++)t(this.source[e])},empty:function(){var t=this.currentLocation||{start:{}};return new eK(t.start.line,t.start.column,this.srcFile)},wrap:function(t){var e=arguments.length<=1||void 0===arguments[1]?this.currentLocation||{start:{}}:arguments[1];return t instanceof eK?t:(t=eW(t,this,e),new eK(e.start.line,e.start.column,this.srcFile,t))},functionCall:function(t,e,n){return n=this.generateList(n),this.wrap([t,e?"."+e+"(":"(",n,")"])},quotedString:function(t){return'"'+(t+"").replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\n/g,"\\n").replace(/\r/g,"\\r").replace(/\u2028/g,"\\u2028")// Per Ecma-262 7.3 + 7.8.4
.replace(/\u2029/g,"\\u2029")+'"'},objectLiteral:function(t){// istanbul ignore next
var e=this,n=[];Object.keys(t).forEach(function(r){var i=eW(t[r],e);"undefined"!==i&&n.push([e.quotedString(r),":",i])});var r=this.generateList(n);return r.prepend("{"),r.add("}"),r},generateList:function(t){for(var e=this.empty(),n=0,r=t.length;n<r;n++)n&&e.add(","),e.add(eW(t[n],this));return e},generateArray:function(t){var e=this.generateList(t);return e.prepend("["),e.add("]"),e}},eq.default=eJ;var ez=eV(eq=eq.default);function eQ(t){this.value=t}function eY(){}eY.prototype={// PUBLIC API: You can override these methods in a subclass to provide
// alternative compiled forms for name lookup and buffering semantics
nameLookup:function(t,e/*,  type */){return this.internalNameLookup(t,e)},depthedLookup:function(t){return[this.aliasable("container.lookup"),"(depths, ",JSON.stringify(t),")"]},compilerInfo:function(){var t=g,e=v[t];return[t,e]},appendToBuffer:function(t,e,n){return(M(t)||(t=[t]),t=this.source.wrap(t,e),this.environment.isSimple)?["return ",t,";"]:n?["buffer += ",t,";"]:(t.appendToBuffer=!0,t)},initializeBuffer:function(){return this.quotedString("")},// END PUBLIC API
...
compiler:eY,compileChildren:function(t,e){for(var n=t.children,r=void 0,i=void 0,o=0,s=n.length;o<s;o++){r=n[o],i=new this.compiler;var a=this.matchExistingProgram(r);if(null==a){this.context.programs.push("");var u=this.context.programs.length;r.index=u,r.name="program"+u,this.context.programs[u]=i.compile(r,e,this.context,!this.precompile),this.context.decorators[u]=i.decorators,this.context.environments[u]=r,this.useDepths=this.useDepths||i.useDepths,this.useBlockParams=this.useBlockParams||i.useBlockParams,r.useDepths=this.useDepths,r.useBlockParams=this.useBlockParams}else r.index=a.index,r.name="program"+a.index,this.useDepths=this.useDepths||a.useDepths,this.useBlockParams=this.useBlockParams||a.useBlockParams}},matchExistingProgram:function(t){for(var e=0,n=this.context.environments.length;e<n;e++){var r=this.context.environments[e];if(r&&r.equals(t))return r}},programExpression:function(t){var e=this.environment.children[t],n=[e.index,"data",e.blockParams];return(this.useBlockParams||this.useDepths)&&n.push("blockParams"),this.useDepths&&n.push("depths"),"container.program("+n.join(", ")+")"},useRegister:function(t){this.registers[t]||(this.registers[t]=!0,this.registers.list.push(t))},push:function(t){return t instanceof eQ||(t=this.source.wrap(t)),this.inlineStack.push(t),t},pushStackLiteral:function(t){this.push(new eQ(t))},pushSource:function(t){this.pendingContent&&(this.source.push(this.appendToBuffer(this.source.quotedString(this.pendingContent),this.pendingLocation)),this.pendingContent=void 0),t&&this.source.push(t)},replaceStack:function(t){var e=["("],n=void 0,r=void 0,i=void 0;/* istanbul ignore next */if(!this.isInline())throw new eG.default("replaceStack on non-inline");// We want to merge the inline statement into the replacement statement via ','
var o=this.popStack(!0);if(o instanceof eQ)e=["(",// Literals do not need to be inlined
n=[o.value]],i=!0;else{// Get or create the current stack name for use by the inline
r=!0;var s=this.incrStack();e=["((",this.push(s)," = ",o,")"],n=this.topStack()}var a=t.call(this,n);i||this.popStack(),r&&this.stackSlot--,this.push(e.concat(a,")"))},incrStack:function(){return this.stackSlot++,this.stackSlot>this.stackVars.length&&this.stackVars.push("stack"+this.stackSlot),this.topStackName()},topStackName:function(){return"stack"+this.stackSlot},flushInline:function(){var t=this.inlineStack;this.inlineStack=[];for(var e=0,n=t.length;e<n;e++){var r=t[e];/* istanbul ignore if */if(r instanceof eQ)this.compileStack.push(r);else{var i=this.incrStack();this.pushSource([i," = ",r,";"]),this.compileStack.push(i)}}},isInline:function(){return this.inlineStack.length},popStack:function(t){var e=this.isInline(),n=(e?this.inlineStack:this.compileStack).pop();if(!t&&n instanceof eQ)return n.value;if(!e){/* istanbul ignore next */if(!this.stackSlot)throw new eG.default("Invalid stack pop");this.stackSlot--}return n},topStack:function(){var t=this.isInline()?this.inlineStack:this.compileStack,e=t[t.length-1];return /* istanbul ignore if */e instanceof eQ?e.value:e},contextName:function(t){return this.useDepths&&t?"depths["+t+"]":"depth"+t},quotedString:function(t){return this.source.quotedString(t)},objectLiteral:function(t){return this.source.objectLiteral(t)},aliasable:function(t){var e=this.aliases[t];return e?e.referenceCount++:((e=this.aliases[t]=this.source.wrap(t)).aliasable=!0,e.referenceCount=1),e},setupHelper:function(t,e,n){var r=[],i=this.setupHelperArgs(e,t,r,n);return{params:r,paramsInit:i,name:this.nameLookup("helpers",e,"helper"),callParams:[this.aliasable(this.contextName(0)+" != null ? "+this.contextName(0)+" : (container.nullContext || {})")].concat(r)}},setupParams:function(t,e,n){var r={},i=[],o=[],s=[],a=!n,u=void 0;a&&(n=[]),r.name=this.quotedString(t),r.hash=this.popStack(),this.trackIds&&(r.hashIds=this.popStack()),this.stringParams&&(r.hashTypes=this.popStack(),r.hashContexts=this.popStack());var l=this.popStack(),c=this.popStack();(c||l)&&(r.fn=c||"container.noop",r.inverse=l||"container.noop");for(// The parameters go on to the stack in order (making sure that they are evaluated in order)
// so we need to pop them off the stack in reverse order
var p=e;p--;)u=this.popStack(),n[p]=u,this.trackIds&&(s[p]=this.popStack()),this.stringParams&&(o[p]=this.popStack(),i[p]=this.popStack());return a&&(r.args=this.source.generateArray(n)),this.trackIds&&(r.ids=this.source.generateArray(s)),this.stringParams&&(r.types=this.source.generateArray(o),r.contexts=this.source.generateArray(i)),this.options.data&&(r.data="data"),this.useBlockParams&&(r.blockParams="blockParams"),r},setupHelperArgs:function(t,e,n,r){var i=this.setupParams(t,e,n);return(i.loc=JSON.stringify(this.source.currentLocation),i=this.objectLiteral(i),r)?(this.useRegister("options"),n.push("options"),["options=",i]):n?(n.push(i),""):i}},function(){for(var t="break else new var case finally return void catch for switch while continue function this with default if throw delete in try do instanceof typeof abstract enum int short boolean export interface static byte extends long super char final native synchronized class float package throws const goto private transient debugger implements protected volatile double import public let yield await null true false".split(" "),e=eY.RESERVED_WORDS={},n=0,r=t.length;n<r;n++)e[t[n]]=!0}(),/**
 * @deprecated May be removed in the next major version
 */eY.isValidJavaScriptVariableName=function(t){return!eY.RESERVED_WORDS[t]&&/^[a-zA-Z_$][0-9a-zA-Z_$]*$/.test(t)},eF.default=eY;var eX=ts(eF=eF.default),eZ=ts(em),e2=ts(er),e1=ea.default.create;function e0(){var t=e1();return t.compile=function(e,n){return function(t,e,n){if(void 0===e&&(e={}),null==t||"string"!=typeof t&&"Program"!==t.type)throw new ej.default("You must pass a string or Handlebars AST to Handlebars.compile. You passed "+t);"data"in(e=b({},e))||(e.data=!0),e.compat&&(e.useDepths=!0);var r=void 0;function i(){var r=n.parse(t,e),i=new n.Compiler().compile(r,e),o=new n.JavaScriptCompiler().compile(i,e,void 0,!0);return n.template(o)}// Template is only compiled on first use and cached after that point.
function o(t,e){return r||(r=i()),r.call(this,t,e)}return o._setup=function(t){return r||(r=i()),r._setup(t)},o._child=function(t,e,n,o){return r||(r=i()),r._child(t,e,n,o)},o}(e,n,t)},t.precompile=function(e,n){return function(t,e,n){if(null==t||"string"!=typeof t&&"Program"!==t.type)throw new ej.default("You must pass a string or Handlebars AST to Handlebars.precompile. You passed "+t);"data"in(e=e||{})||(e.data=!0),e.compat&&(e.useDepths=!0);var r=n.parse(t,e),i=new n.Compiler().compile(r,e);return new n.JavaScriptCompiler().compile(i,e)}(e,n,t)},t.AST=ec.default,t.Compiler=eT,t.JavaScriptCompiler=eX.default,t.Parser=U,t.parse=eB,t.parseWithoutProcessing=eR,t}var e3=e0();e3.create=e0,e2.default(e3),e3.Visitor=eZ.default,e3.default=e3,to.default=e3;var e4=(to=to.default).default,e8=(c=em)&&c.__esModule?c:{default:c};function e5(){this.padding=0}e5.prototype=new e8.default,e5.prototype.pad=function(t){for(var e="",n=0,r=this.padding;n<r;n++)e+="  ";return e+(t+"\n")},e5.prototype.Program=function(t){var e="",n=t.body,r=void 0,i=void 0;if(t.blockParams){var o="BLOCK PARAMS: [";for(r=0,i=t.blockParams.length;r<i;r++)o+=" "+t.blockParams[r];o+=" ]",e+=this.pad(o)}for(r=0,i=n.length;r<i;r++)e+=this.accept(n[r]);return this.padding--,e},e5.prototype.MustacheStatement=function(t){return this.pad("{{ "+this.SubExpression(t)+" }}")},e5.prototype.Decorator=function(t){return this.pad("{{ DIRECTIVE "+this.SubExpression(t)+" }}")},e5.prototype.BlockStatement=e5.prototype.DecoratorBlock=function(t){var e="";return e+=this.pad(("DecoratorBlock"===t.type?"DIRECTIVE ":"")+"BLOCK:"),this.padding++,e+=this.pad(this.SubExpression(t)),t.program&&(e+=this.pad("PROGRAM:"),this.padding++,e+=this.accept(t.program),this.padding--),t.inverse&&(t.program&&this.padding++,e+=this.pad("{{^}}"),this.padding++,e+=this.accept(t.inverse),this.padding--,t.program&&this.padding--),this.padding--,e},e5.prototype.PartialStatement=function(t){var e="PARTIAL:"+t.name.original;return t.params[0]&&(e+=" "+this.accept(t.params[0])),t.hash&&(e+=" "+this.accept(t.hash)),this.pad("{{> "+e+" }}")},e5.prototype.PartialBlockStatement=function(t){var e="PARTIAL BLOCK:"+t.name.original;return t.params[0]&&(e+=" "+this.accept(t.params[0])),t.hash&&(e+=" "+this.accept(t.hash)),e+=" "+this.pad("PROGRAM:"),this.padding++,e+=this.accept(t.program),this.padding--,this.pad("{{> "+e+" }}")},e5.prototype.ContentStatement=function(t){return this.pad("CONTENT[ '"+t.value+"' ]")},e5.prototype.CommentStatement=function(t){return this.pad("{{! '"+t.value+"' }}")},e5.prototype.SubExpression=function(t){for(var e=t.params,n=[],r=void 0,i=0,o=e.length;i<o;i++)n.push(this.accept(e[i]));return e="["+n.join(", ")+"]",r=t.hash?" "+this.accept(t.hash):"",this.accept(t.path)+" "+e+r},e5.prototype.PathExpression=function(t){var e=t.parts.join("/");return(t.data?"@":"")+"PATH:"+e},e5.prototype.StringLiteral=function(t){return'"'+t.value+'"'},e5.prototype.NumberLiteral=function(t){return"NUMBER{"+t.value+"}"},e5.prototype.BooleanLiteral=function(t){return"BOOLEAN{"+t.value+"}"},e5.prototype.UndefinedLiteral=function(){return"UNDEFINED"},e5.prototype.NullLiteral=function(){return"NULL"},e5.prototype.Hash=function(t){for(var e=t.pairs,n=[],r=0,i=e.length;r<i;r++)n.push(this.accept(e[r]));return"HASH{"+n.join(", ")+"}"},e5.prototype.HashPair=function(t){return t.key+"="+this.accept(t.value)},e4.PrintVisitor=e5,e4.print=function(t){return new e5().accept(t)};var e7=((p=e4)&&p.__esModule?p.default:p).template({1:function(t,e,n,r,i){var o,s=null!=e?e:t.nullContext||{},a=t.hooks.helperMissing,u="function",l=t.escapeExpression,c=t.lookupProperty||function(t,e){if(Object.prototype.hasOwnProperty.call(t,e))return t[e]};return'<li>\n    <a href="" target="_blank" rel="noopener noreferrer">\n      <article>\n        <img src="'+l((void 0===(o=null!=(o=c(n,"largeImageURL")||(null!=e?c(e,"largeImageURL"):e))?o:a)?"undefined":tr(o))===u?o.call(s,{name:"largeImageURL",hash:{},data:i,loc:{start:{line:5,column:18},end:{line:5,column:35}}}):o)+'" alt="" width="480">\n        <h2></h2>\n        <p>Posted by: '+l((void 0===(o=null!=(o=c(n,"user")||(null!=e?c(e,"user"):e))?o:a)?"undefined":tr(o))===u?o.call(s,{name:"user",hash:{},data:i,loc:{start:{line:7,column:22},end:{line:7,column:30}}}):o)+"</p>\n        <p>"+l((void 0===(o=null!=(o=c(n,"tags")||(null!=e?c(e,"tags"):e))?o:a)?"undefined":tr(o))===u?o.call(s,{name:"tags",hash:{},data:i,loc:{start:{line:8,column:11},end:{line:8,column:19}}}):o)+"</p>\n      </article>\n    </a>\n</li> \n"},compiler:[8,">= 4.3.0"],main:function(t,e,n,r,i){var o;return null!=(o=(t.lookupProperty||function(t,e){if(Object.prototype.hasOwnProperty.call(t,e))return t[e]})(n,"each").call(null!=e?e:t.nullContext||{},e,{name:"each",hash:{},fn:t.program(1,i,0),inverse:t.noop,data:i,loc:{start:{line:1,column:0},end:{line:12,column:9}}}))?o:""},useData:!0});function e6(t,e){for(var n=0;n<e.length;n++){var r=e[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}var e9=/*#__PURE__*/function(){var t;function e(){!function(t,e){if(!(t instanceof e))throw TypeError("Cannot call a class as a function")}(this,e),this.searchQuery="",this.page=1}return e6(e.prototype,[{key:"fetchArticles",value:function(t){var e=this;return fetch("".concat("https://pixabay.com/api/","?key=").concat("39207227-e0b610c42232251ba1ba1b4e0","&q=").concat(this.searchQuery,"&image_type=photo&per_page=20&page=").concat(this.page)).then(function(t){return t.json()}).then(function(t){return e.increasePage(),t.hits})}},{key:"increasePage",value:function(){this.page+=1}},{key:"resetPage",value:function(){this.page=1}}]),t&&e6(e,t),e}(),nt=document.querySelector(".js-search-form"),ne=document.querySelector(".js-articles-container"),nn=document.querySelector('[data-action="load-more"]'),nr=new e9;function ni(t){var e=e7(t);ne.innerHTML=e}nr.fetchArticles(),nt.addEventListener("submit",function(t){t.preventDefault();var e=t.currentTarget;nr.searchQuery=e.elements.query.value,nr.resetPage(),nr.fetchArticles(searchQuery).then(function(t){return ni(t)})}),nn.addEventListener("click",function(){nr.fetchArticles(searchQuery).then(function(t){return ni(t)})})}();//# sourceMappingURL=index.cce1ee96.js.map

//# sourceMappingURL=index.cce1ee96.js.map
